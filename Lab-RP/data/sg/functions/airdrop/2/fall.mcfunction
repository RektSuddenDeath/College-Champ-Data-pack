...
scoreboard players set airdropValue sg_game 50
scoreboard players set airdropNo sg_game 2

tag @e[type=marker,tag=sg_airdrop] remove airdrop_selected
tag @e[type=marker,tag=airdrop_2,limit=1,sort=random] add airdrop_selected
