...
function acerace3:scoreboard/refresh_macro with storage ar_sb_temp

scoreboard objectives remove ar_sb_temp

execute if score gameflag ar_game matches 1 run schedule function acerace3:scoreboard/refresh 10t