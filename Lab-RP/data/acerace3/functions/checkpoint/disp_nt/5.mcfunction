...
tellraw @s ["第",{"score":{"name": "@s","objective": "ar_laps"},"color": "aqua"},"§b/4","圈 ","区域§b5/8", ""," (",{"score":{"name": "@s","objective": "ar_secdif_m"},"color": "yellow"},"§e:",{"score":{"name": "@s","objective": "ar_zeropad_s"},"color": "yellow"},{"score":{"name": "@s","objective": "ar_secdif_s"},"color": "yellow"},"§e.",{"score":{"name": "@s","objective": "ar_zeropad_ms"},"color": "yellow"},{"score":{"name": "@s","objective": "ar_secdif_ms"},"color": "yellow"},")"]
