...
execute unless score disapprove posAnchors matches 3 run execute as @p[tag=gen] at @s run summon area_effect_cloud ~ ~ ~ {Duration:999999999,WaitTime:-99999999,Tags:["posAnchor","newAnchor","map3"]}
...
schedule function acerace3:anchorsgen/loop 2t