...
tellraw @a ["§b[§r褿§b] ",{"translate":"team.cyan"},"§b已通过存档点","§f#1","§b!"]
...
function railroadrush:checkpoint/1/cyan/summon_railfixer
function railroadrush:checkpoint/2/cyan/setup