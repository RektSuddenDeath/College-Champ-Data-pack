...
execute store result score result rsr_explode_adjust_success run function test:aug10_fireballtest/weapon/explode_adjust/2 with storage rsr:explode_adjust
...
# 都不符合递归。
function test:aug10_fireballtest/weapon/explode_adjust/macro_loop
