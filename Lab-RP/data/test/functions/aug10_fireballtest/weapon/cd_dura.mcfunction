...
# function test:aug10_fireballtest/weapon/abar/loop

# Loop
#execute if score gameflag rsr_game matches 1 run schedule function test:aug10_fireballtest/weapon/cd_dura 1t