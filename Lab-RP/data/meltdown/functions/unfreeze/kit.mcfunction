...
clear @s
function meltdown:unfreeze/retrieve_bow
function meltdown:unfreeze/retrieve_telepickaxe
...
execute if entity @s[tag=!meltdown_has_heater_placed] run scoreboard players set @s meltdown_heater_cooldown 39
tag @s remove meltdown_map_in_offhand
