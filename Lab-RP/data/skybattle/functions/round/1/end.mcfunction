...
# Regenerate arena in 10s, DO NOT DO THIS WHILE IN EVENT MODE
execute if score eventmode tourney_stats matches 0 if score map sba_game matches 1 run schedule function skybattle:structure/zone1/classic/place 190t
execute if score eventmode tourney_stats matches 0 if score map sba_game matches 2 run schedule function skybattle:structure/zone1/sandcastle/place 190t
execute if score eventmode tourney_stats matches 0 if score map sba_game matches 3 run schedule function skybattle:structure/zone1/wasteland/place 190t
execute if score eventmode tourney_stats matches 0 if score map sba_game matches 4 run schedule function skybattle:structure/zone1/cakesland/place 190t
