...
execute if score map sba_game matches 1 run tp @a 13000 105 13000
execute if score map sba_game matches 2 run tp @a 23000 50 23000
execute if score map sba_game matches 3 run tp @a 33000 50 33000
execute if score map sba_game matches 4 run tp @a 43000 50 43000
...
scoreboard players set round sba_game 2
...
team modify placeholder_5 suffix ["",{"text": "2/3"}]
# Border Create, also generates the center
forceload add 13000 13000
forceload add 23000 23000
forceload add 33000 33000
forceload add 43000 43000

function skybattle:border/init2
# Teleport Players
