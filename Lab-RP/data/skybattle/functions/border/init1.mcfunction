...
execute if score map sba_game matches 1 run summon area_effect_cloud 12000 0 12000 {Duration:999999,Tags:[skybattle,bordercenter]}
execute if score map sba_game matches 2 run summon area_effect_cloud 22000 0 22000 {Duration:999999,Tags:[skybattle,bordercenter]}
execute if score map sba_game matches 3 run summon area_effect_cloud 32000 0 32000 {Duration:999999,Tags:[skybattle,bordercenter]}
execute if score map sba_game matches 4 run summon area_effect_cloud 42000 0 42000 {Duration:999999,Tags:[skybattle,bordercenter]}
