...
tellraw @a ["第6间: ","Dig Site"]

scoreboard players set Step gr_ranking 1
execute as @e[type=area_effect_cloud,tag=gr_general] run scoreboard players operation @s gr_ranktime = @s gr_room6time
...
execute as @e[type=area_effect_cloud,tag=gr_general] run scoreboard players operation @s gr_rankmin = @s gr_room6time
execute as @e[type=area_effect_cloud,tag=gr_general] run scoreboard players operation @s gr_ranksec = @s gr_room6time
execute as @e[type=area_effect_cloud,tag=gr_general] run scoreboard players operation @s gr_rankms = @s gr_room6time
...
execute as @e[type=area_effect_cloud,tag=gr_redany] if score @s gr_room6time matches 0 run tellraw @a[team=red] ["","[","§60分","§r]"," §7你的队伍没有完成此房间。"]
execute as @e[type=area_effect_cloud,tag=gr_blueany] if score @s gr_room6time matches 0 run tellraw @a[team=blue] ["","[","§60分","§r]"," §7你的队伍没有完成此房间。"]
execute as @e[type=area_effect_cloud,tag=gr_greenany] if score @s gr_room6time matches 0 run tellraw @a[team=green] ["","[","§60分","§r]"," §7你的队伍没有完成此房间。"]
execute as @e[type=area_effect_cloud,tag=gr_yellowany] if score @s gr_room6time matches 0 run tellraw @a[team=yellow] ["","[","§60分","§r]"," §7你的队伍没有完成此房间。"]
execute as @e[type=area_effect_cloud,tag=gr_cyanany] if score @s gr_room6time matches 0 run tellraw @a[team=cyan] ["","[","§60分","§r]"," §7你的队伍没有完成此房间。"]
execute as @e[type=area_effect_cloud,tag=gr_orangeany] if score @s gr_room6time matches 0 run tellraw @a[team=orange] ["","[","§60分","§r]"," §7你的队伍没有完成此房间。"]
execute as @e[type=area_effect_cloud,tag=gr_pinkany] if score @s gr_room6time matches 0 run tellraw @a[team=pink] ["","[","§60分","§r]"," §7你的队伍没有完成此房间。"]
execute as @e[type=area_effect_cloud,tag=gr_purpleany] if score @s gr_room6time matches 0 run tellraw @a[team=purple] ["","[","§60分","§r]"," §7你的队伍没有完成此房间。"]
# Income Sound is played for players who have scored this period.
execute as @e[type=area_effect_cloud,tag=gr_redany] if score @s gr_room6time matches 1.. run execute as @a[team=red] at @s run playsound sound.acquire record @s ~ ~ ~ 1.2 1
execute as @e[type=area_effect_cloud,tag=gr_blueany] if score @s gr_room6time matches 1.. run execute as @a[team=blue] at @s run playsound sound.acquire record @s ~ ~ ~ 1.2 1
execute as @e[type=area_effect_cloud,tag=gr_greenany] if score @s gr_room6time matches 1.. run execute as @a[team=green] at @s run playsound sound.acquire record @s ~ ~ ~ 1.2 1
execute as @e[type=area_effect_cloud,tag=gr_yellowany] if score @s gr_room6time matches 1.. run execute as @a[team=yellow] at @s run playsound sound.acquire record @s ~ ~ ~ 1.2 1
execute as @e[type=area_effect_cloud,tag=gr_cyanany] if score @s gr_room6time matches 1.. run execute as @a[team=cyan] at @s run playsound sound.acquire record @s ~ ~ ~ 1.2 1
execute as @e[type=area_effect_cloud,tag=gr_orangeany] if score @s gr_room6time matches 1.. run execute as @a[team=orange] at @s run playsound sound.acquire record @s ~ ~ ~ 1.2 1
execute as @e[type=area_effect_cloud,tag=gr_pinkany] if score @s gr_room6time matches 1.. run execute as @a[team=pink] at @s run playsound sound.acquire record @s ~ ~ ~ 1.2 1
execute as @e[type=area_effect_cloud,tag=gr_purpleany] if score @s gr_room6time matches 1.. run execute as @a[team=purple] at @s run playsound sound.acquire record @s ~ ~ ~ 1.2 1
# Transcript
tellraw @a[tag=_transcript] ["  §bTranscript >> ","§fRoom 6 times:"]
