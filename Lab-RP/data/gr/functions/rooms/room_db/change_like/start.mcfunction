...
execute store result storage gr:function_data room_no int 1 run scoreboard players add blue gr_currentroom 1
...
function gr:rooms/room_db/main/start with storage gr:function_data
