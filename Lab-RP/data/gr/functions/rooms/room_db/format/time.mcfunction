...
# 显示房间目标和当前用时
$execute if score $(team) gr_currentsec matches 0..9 run title @a[team=$(team)] actionbar ["",{"score":{"name": "$(team)","objective": "gr_currentmin"}},":","0",{"score":{"name": "$(team)","objective": "gr_currentsec"}}," | ","[§e!§r]"," 关卡要求。"]
$execute if score $(team) gr_currentsec matches 10..59 run title @a[team=$(team)] actionbar ["",{"score":{"name": "$(team)","objective": "gr_currentmin"}},":","",{"score":{"name": "$(team)","objective": "gr_currentsec"}}," | ","[§e!§r]"," 关卡要求。"]