...
# Modify scoreboard
scoreboard players display name var_room_name gr_orangesb "§a§l当前房间: §rAquarium Targets"
...
title @a[team=orange] title "§e射击全部标靶！"
# Give items
clear @a[team=orange]
give @a[team=orange] trident{Enchantments:[{id:"loyalty",lvl:3}],Unbreakable:1b} 2
