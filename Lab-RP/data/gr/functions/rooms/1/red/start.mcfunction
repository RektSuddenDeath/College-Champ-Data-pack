...
# Modify scoreboard
scoreboard players display name var_room_name gr_redsb "§a§l当前房间: §rAquarium Targets"
...
title @a[team=red] title "§e射击全部标靶！"
# Give items
clear @a[team=red]
give @a[team=red] trident{Enchantments:[{id:"loyalty",lvl:3}],Unbreakable:1b} 2
