...
execute as @e[type=minecraft:area_effect_cloud,tag=gr_greenanchor] at @s run fill ~14 101 ~16 ~14 101 ~14 air

# Playsound
execute as @a[team=green] at @s run playsound gr.roomcomplete record @s

# Save times
scoreboard players operation @e[type=area_effect_cloud,tag=gr_general,tag=gr_greenany] gr_room3time = green gr_currenttime
# Trim
...
scoreboard players operation green gr_currentpos = 3 gr_indvroom
function gr:scoreboard/calc

# Announce position
tellraw @a[team=!green] ["",{"translate":"team.green"},"§7第",{"score":{"name": "3","objective": "gr_indvroom"},"color": "aqua"},"§7个完成了房间","§e[","§bIce and Fire","§e]"]
tellraw @a[team=green] ["","§7你","§7第",{"score":{"name": "3","objective": "gr_indvroom"},"color": "aqua"},"§7个完成了房间","§e[","§bIce and Fire","§e]"]
# Initiate next room
...
function gr:rooms/4/green/divider
function gr:rooms/4/green/master