...
# Save times
scoreboard players operation @e[type=area_effect_cloud,tag=gr_general,tag=gr_cyanany] gr_room5time = cyan gr_currenttime
# Trim
...
scoreboard players operation cyan gr_currentpos = 5 gr_indvroom
function gr:scoreboard/calc

# Announce position
tellraw @a[team=!cyan] ["",{"translate":"team.cyan"},"§7第",{"score":{"name": "5","objective": "gr_indvroom"},"color": "aqua"},"§7个完成了房间","§e[","§dSearch The House","§e]"]
tellraw @a[team=cyan] ["","§7你","§7第",{"score":{"name": "5","objective": "gr_indvroom"},"color": "aqua"},"§7个完成了房间","§e[","§dSearch The House","§e]"]
# Initiate next room
...
function gr:rooms/6/cyan/divider
function gr:rooms/6/cyan/master