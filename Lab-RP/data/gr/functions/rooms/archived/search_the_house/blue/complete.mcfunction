...
# Save times
scoreboard players operation @e[type=area_effect_cloud,tag=gr_general,tag=gr_blueany] gr_room5time = blue gr_currenttime
# Trim
...
scoreboard players operation blue gr_currentpos = 5 gr_indvroom
function gr:scoreboard/calc

# Announce position
tellraw @a[team=!blue] ["",{"translate":"team.blue"},"§7第",{"score":{"name": "5","objective": "gr_indvroom"},"color": "aqua"},"§7个完成了房间","§e[","§dSearch The House","§e]"]
tellraw @a[team=blue] ["","§7你","§7第",{"score":{"name": "5","objective": "gr_indvroom"},"color": "aqua"},"§7个完成了房间","§e[","§dSearch The House","§e]"]
# Initiate next room
...
function gr:rooms/6/blue/divider
function gr:rooms/6/blue/master