...
# Modify scoreboard
scoreboard players display name var_room_name gr_redsb "§a§l当前房间: §rMesa Range"
...
title @a[team=red] title "§e击碎所有陶罐！"
# Give items
clear @a[team=red]
give @a[team=red] bow{Unbreakable:1b} 3
give @a[team=red] arrow 192
# 开始计时
