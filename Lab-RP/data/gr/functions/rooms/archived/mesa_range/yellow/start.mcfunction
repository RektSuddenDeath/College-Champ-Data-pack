...
# Modify scoreboard
scoreboard players display name var_room_name gr_yellowsb "§a§l当前房间: §rMesa Range"
...
title @a[team=yellow] title "§e击碎所有陶罐！"
# Give items
clear @a[team=yellow]
give @a[team=yellow] bow{Unbreakable:1b} 3
give @a[team=yellow] arrow 192
# 开始计时
