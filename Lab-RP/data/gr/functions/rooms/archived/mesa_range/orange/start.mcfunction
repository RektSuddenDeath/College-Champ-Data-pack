...
# Modify scoreboard
scoreboard players display name var_room_name gr_orangesb "§a§l当前房间: §rMesa Range"
...
title @a[team=orange] title "§e击碎所有陶罐！"
# Give items
clear @a[team=orange]
give @a[team=orange] bow{Unbreakable:1b} 3
give @a[team=orange] arrow 192
# 开始计时
