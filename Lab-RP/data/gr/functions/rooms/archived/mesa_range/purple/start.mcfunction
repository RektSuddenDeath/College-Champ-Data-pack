...
# Modify scoreboard
scoreboard players display name var_room_name gr_purplesb "§a§l当前房间: §rMesa Range"
...
title @a[team=purple] title "§e击碎所有陶罐！"
# Give items
clear @a[team=purple]
give @a[team=purple] bow{Unbreakable:1b} 3
give @a[team=purple] arrow 192
# 开始计时
