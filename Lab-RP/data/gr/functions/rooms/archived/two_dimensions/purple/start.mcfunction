...
# Modify scoreboard
scoreboard players display name var_room_name gr_purplesb "§a§l当前房间: §rTwo Dimensions"
...
title @a[team=purple] title "§e收集所需物品！"
# Give items
clear @a[team=purple]
recipe give @a[team=purple] comparator
recipe give @a[team=purple] clock
# 开始计时
