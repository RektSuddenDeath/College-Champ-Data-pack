...
execute as @e[type=minecraft:area_effect_cloud,tag=gr_blueanchor] at @s run fill ~11 ~12 ~6 ~11 ~15 ~8 air
execute as @e[type=minecraft:area_effect_cloud,tag=gr_blueanchor] at @s run fill ~11 ~12 ~22 ~11 ~15 ~24 air
# Playsound
...
# Announce position
tellraw @a[team=!blue] ["",{"translate":"team.blue"},"§7第",{"score":{"name": "7","objective": "gr_indvroom"},"color": "aqua"},"§7个完成了房间","§e[","§aTwo Dimensions","§e]"]
tellraw @a[team=blue] ["","§7你","§7第",{"score":{"name": "7","objective": "gr_indvroom"},"color": "aqua"},"§7个完成了房间","§e[","§aTwo Dimensions","§e]"]
# Initiate next room
