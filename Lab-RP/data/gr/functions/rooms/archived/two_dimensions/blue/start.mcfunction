...
# Modify scoreboard
scoreboard players display name var_room_name gr_bluesb "§a§l当前房间: §rTwo Dimensions"
...
title @a[team=blue] title "§e收集所需物品！"
# Give items
clear @a[team=blue]
recipe give @a[team=blue] comparator
recipe give @a[team=blue] clock
# 开始计时
