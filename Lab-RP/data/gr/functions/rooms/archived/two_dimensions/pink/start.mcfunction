...
# Modify scoreboard
scoreboard players display name var_room_name gr_pinksb "§a§l当前房间: §rTwo Dimensions"
...
title @a[team=pink] title "§e收集所需物品！"
# Give items
clear @a[team=pink]
recipe give @a[team=pink] comparator
recipe give @a[team=pink] clock
# 开始计时
