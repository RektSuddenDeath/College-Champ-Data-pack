...
execute as @e[type=minecraft:area_effect_cloud,tag=gr_redanchor] at @s run fill ~8 ~10 ~22 ~8 ~13 ~24 air
# Playsound
...
scoreboard players operation red gr_currentpos = 6 gr_indvroom
function gr:scoreboard/calc

# Announce position
tellraw @a[team=!red] ["",{"translate":"team.red"},"§7第",{"score":{"name": "6","objective": "gr_indvroom"},"color": "aqua"},"§7个完成了房间","§e[","§bGravity Palette","§e]"]
tellraw @a[team=red] ["","§7你","§7第",{"score":{"name": "6","objective": "gr_indvroom"},"color": "aqua"},"§7个完成了房间","§e[","§bGravity Palette","§e]"]
# Initiate next room
scoreboard players add red gr_teamphase 1
execute as @e[type=minecraft:area_effect_cloud,tag=gr_redanchor] at @s run tp @s ~-47 ~ ~
function gr:rooms/7/red/divider
function gr:rooms/7/red/master