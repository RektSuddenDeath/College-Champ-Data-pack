...
# Modify scoreboard
scoreboard players display name var_room_name gr_bluesb "§a§l当前房间: §rPottery Hunt"
...
title @a[team=blue] title "§e合成陶罐！"
# Give items
clear @a[team=blue]
give @a[team=blue] brush{Unbreakable:1b,CanPlaceOn:[suspicious_sand]}
give @a[team=blue] iron_shovel{Unbreakable:1b,CanDestroy:[gravel,sand,decorated_pot],Enchantments:[{id:"efficiency",lvl:2}],display:{Name:'"§r铁锹 （可破坏沙子、沙砾、陶罐）"'}}
# 开始计时
