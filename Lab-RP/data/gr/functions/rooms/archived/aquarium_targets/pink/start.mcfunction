...
# Modify scoreboard
scoreboard players display name var_room_name gr_pinksb "§a§l当前房间: §rAquarium Targets"
...
title @a[team=pink] title "§e射击全部标靶！"
# Give items
clear @a[team=pink]
give @a[team=pink] trident{Enchantments:[{id:"loyalty",lvl:3}],Unbreakable:1b} 2
