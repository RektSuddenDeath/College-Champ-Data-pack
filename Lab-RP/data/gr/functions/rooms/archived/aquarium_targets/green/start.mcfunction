...
# Modify scoreboard
scoreboard players display name var_room_name gr_greensb "§a§l当前房间: §rAquarium Targets"
...
title @a[team=green] title "§e射击全部标靶！"
# Give items
clear @a[team=green]
give @a[team=green] trident{Enchantments:[{id:"loyalty",lvl:3}],Unbreakable:1b} 2
