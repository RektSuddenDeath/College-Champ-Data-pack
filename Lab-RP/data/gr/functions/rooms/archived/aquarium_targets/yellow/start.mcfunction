...
# Modify scoreboard
scoreboard players display name var_room_name gr_yellowsb "§a§l当前房间: §rAquarium Targets"
...
title @a[team=yellow] title "§e射击全部标靶！"
# Give items
clear @a[team=yellow]
give @a[team=yellow] trident{Enchantments:[{id:"loyalty",lvl:3}],Unbreakable:1b} 2
