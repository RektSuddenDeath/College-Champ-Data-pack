...
# Modify scoreboard
scoreboard players display name var_room_name gr_orangesb "§a§l当前房间: §rHoneycomb"
...
# Give items
clear @a[team=orange]
give @a[team=orange] shears{CanDestroy:[magenta_wool,purple_wool,green_wool,cyan_wool],Unbreakable:1b}
