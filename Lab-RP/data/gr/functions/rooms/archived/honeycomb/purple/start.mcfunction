...
# Modify scoreboard
scoreboard players display name var_room_name gr_purplesb "§a§l当前房间: §rHoneycomb"
...
# Give items
clear @a[team=purple]
give @a[team=purple] shears{CanDestroy:[magenta_wool,purple_wool,green_wool,cyan_wool],Unbreakable:1b}
