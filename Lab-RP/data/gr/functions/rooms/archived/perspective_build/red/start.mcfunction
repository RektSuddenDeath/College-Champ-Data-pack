...
# Modify scoreboard
scoreboard players display name var_room_name gr_redsb "§a§l当前房间: §rPerspective Build"
...
title @a[team=red] title "§e复制建筑！"
# Give items
clear @a[team=red]
give @a[team=red] iron_pickaxe{Unbreakable:1b,CanDestroy:[redstone_block,lapis_block,emerald_block,raw_gold_block]}
# 开始计时
