...
# Modify scoreboard
scoreboard players display name var_room_name gr_bluesb "§a§l当前房间: §rPerspective Build"
...
title @a[team=blue] title "§e复制建筑！"
# Give items
clear @a[team=blue]
give @a[team=blue] iron_pickaxe{Unbreakable:1b,CanDestroy:[redstone_block,lapis_block,emerald_block,raw_gold_block]}
# 开始计时
