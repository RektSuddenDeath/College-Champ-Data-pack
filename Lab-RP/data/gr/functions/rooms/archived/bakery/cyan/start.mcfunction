...
# Modify scoreboard
scoreboard players display name var_room_name gr_cyansb "§a§l当前房间: §rBakery"
...
title @a[team=cyan] title "§e吃掉全部蛋糕！"
# Give items
clear @a[team=cyan]
effect clear @a[team=cyan] saturation
effect give @a[team=cyan] hunger infinite 255 true
