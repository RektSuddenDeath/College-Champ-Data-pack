...
# Modify scoreboard
scoreboard players display name var_room_name gr_bluesb "§a§l当前房间: §rGolf"
...
title @a[team=blue] title "§e将你的队友射入洞中！"
# Give items
clear @a[team=blue]
give @a[team=blue] stick{Enchantments:[{id:"knockback",lvl:2}]}
