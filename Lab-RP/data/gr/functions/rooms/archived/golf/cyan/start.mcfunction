...
# Modify scoreboard
scoreboard players display name var_room_name gr_cyansb "§a§l当前房间: §rGolf"
...
title @a[team=cyan] title "§e将你的队友射入洞中！"
# Give items
clear @a[team=cyan]
give @a[team=cyan] stick{Enchantments:[{id:"knockback",lvl:2}]}
