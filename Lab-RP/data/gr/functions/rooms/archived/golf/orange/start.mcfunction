...
# Modify scoreboard
scoreboard players display name var_room_name gr_orangesb "§a§l当前房间: §rGolf"
...
title @a[team=orange] title "§e将你的队友射入洞中！"
# Give items
clear @a[team=orange]
give @a[team=orange] stick{Enchantments:[{id:"knockback",lvl:2}]}
