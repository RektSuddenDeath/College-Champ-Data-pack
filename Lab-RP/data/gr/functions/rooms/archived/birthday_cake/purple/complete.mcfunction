...
execute as @e[type=minecraft:area_effect_cloud,tag=gr_purpleanchor] at @s run setblock ~14 104 ~15 candle_cake[lit=true]
...
# Announce position
tellraw @a[team=!purple] ["",{"translate":"team.purple"},"§7第",{"score":{"name": "8","objective": "gr_indvroom"},"color": "aqua"},"§7个完成了房间","§e[","§dBirthday Cake!","§e]"]
tellraw @a[team=purple] ["","§7你","§7第",{"score":{"name": "8","objective": "gr_indvroom"},"color": "aqua"},"§7个完成了房间","§e[","§dBirthday Cake!","§e]"]
# Initiate next room
