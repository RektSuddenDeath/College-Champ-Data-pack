...
# Status Effects
scoreboard players set @a[team=green] univ_death 0
effect clear @a[team=green] resistance
effect give @a[team=green] absorption infinite 1 true
execute as @a[team=green] run attribute @s generic.max_health base set 1.0

# Add a team phase
scoreboard players add green gr_teamphase 1

# Modify scoreboard
scoreboard players display name var_room_name gr_greensb "§a§l当前房间: §rSunken Chambers"
