...
# Status Effects
scoreboard players set @a[team=pink] univ_death 0
effect clear @a[team=pink] resistance
effect give @a[team=pink] absorption infinite 1 true
execute as @a[team=pink] run attribute @s generic.max_health base set 1.0

# Add a team phase
scoreboard players add pink gr_teamphase 1

# Modify scoreboard
scoreboard players display name var_room_name gr_pinksb "§a§l当前房间: §rSunken Chambers"
