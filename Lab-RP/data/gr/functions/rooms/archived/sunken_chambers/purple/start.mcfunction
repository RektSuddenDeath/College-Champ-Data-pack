...
# Status Effects
scoreboard players set @a[team=purple] univ_death 0
effect clear @a[team=purple] resistance
effect give @a[team=purple] absorption infinite 1 true
execute as @a[team=purple] run attribute @s generic.max_health base set 1.0

# Add a team phase
scoreboard players add purple gr_teamphase 1

# Modify scoreboard
scoreboard players display name var_room_name gr_purplesb "§a§l当前房间: §rSunken Chambers"
