...
kill @e[type=warden,tag=yellow,tag=grroom]
# Reapply Night Vision
effect give @a[team=yellow] night_vision 1000000 0 true
...
# Announce position
tellraw @a[team=!yellow] ["",{"translate":"team.yellow"},"§7第",{"score":{"name": "3","objective": "gr_indvroom"},"color": "aqua"},"§7个完成了房间","§e[","§7Ancient City","§e]"]
tellraw @a[team=yellow] ["","§7你","§7第",{"score":{"name": "3","objective": "gr_indvroom"},"color": "aqua"},"§7个完成了房间","§e[","§7Ancient City","§e]"]
# Initiate next room
