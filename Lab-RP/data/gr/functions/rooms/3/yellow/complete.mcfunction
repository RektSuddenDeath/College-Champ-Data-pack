...
execute as @e[type=minecraft:area_effect_cloud,tag=gr_yellowanchor] at @s run fill ~14 101 ~16 ~14 101 ~14 air
...
# Announce position
tellraw @a[team=!yellow] ["",{"translate":"team.yellow"},"§7第",{"score":{"name": "3","objective": "gr_indvroom"},"color": "aqua"},"§7个完成了房间","§e[","§bIce and Fire","§e]"]
tellraw @a[team=yellow] ["","§7你","§7第",{"score":{"name": "3","objective": "gr_indvroom"},"color": "aqua"},"§7个完成了房间","§e[","§bIce and Fire","§e]"]
# Initiate next room
