...
schedule clear decisiondome:team_intro/phase_loop/14
tag @a[team=yellow] add team_intro_tp
effect clear @a[team=green] invisibility
...
tellraw @a ""
tellraw @a ["§e黄队: ",{"selector":"@a[team=yellow]"}]