...
schedule clear decisiondome:team_intro/phase_loop/12
tag @a[team=green] add team_intro_tp
effect clear @a[team=blue] invisibility
...
tellraw @a ""
tellraw @a ["§a绿队: ",{"selector":"@a[team=green]"}]