...
schedule clear decisiondome:team_intro/phase_loop/16
tag @a[team=cyan] add team_intro_tp
effect clear @a[team=yellow] invisibility
effect clear @a[team=cyan] invisibility
...
title @a title ["§3§l青队"]
title @a subtitle [{"selector":"@a[team=cyan]"}] 
title @a times 5 30 5

tellraw @a ""
tellraw @a ["§3青队: ",{"selector":"@a[team=cyan]"}]