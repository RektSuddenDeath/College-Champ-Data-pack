tellraw @a[scores={standings=1..}] ["",{"text": "当前 Rocket Spleef Rush 排行","bold": true}]
tellraw @a[scores={standings=1..}] ""

execute as @a[team=red] run scoreboard players operation red standingsCache += @s rsr_indvscore
execute as @a[team=blue] run scoreboard players operation blue standingsCache += @s rsr_indvscore
execute as @a[team=green] run scoreboard players operation green standingsCache += @s rsr_indvscore
execute as @a[team=yellow] run scoreboard players operation yellow standingsCache += @s rsr_indvscore
execute as @a[team=cyan] run scoreboard players operation cyan standingsCache += @s rsr_indvscore
execute as @a[team=orange] run scoreboard players operation orange standingsCache += @s rsr_indvscore
execute as @a[team=purple] run scoreboard players operation purple standingsCache += @s rsr_indvscore
execute as @a[team=pink] run scoreboard players operation pink standingsCache += @s rsr_indvscore
