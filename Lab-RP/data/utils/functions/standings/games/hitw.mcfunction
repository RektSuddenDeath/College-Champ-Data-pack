tellraw @a[scores={standings=1..}] ["",{"text": "当前 Hole in the Wall 排行","bold": true}]
tellraw @a[scores={standings=1..}] ""

execute as @a[team=red] run scoreboard players operation red standingsCache += @s hitw_indvscore
execute as @a[team=blue] run scoreboard players operation blue standingsCache += @s hitw_indvscore
execute as @a[team=green] run scoreboard players operation green standingsCache += @s hitw_indvscore
execute as @a[team=yellow] run scoreboard players operation yellow standingsCache += @s hitw_indvscore
execute as @a[team=cyan] run scoreboard players operation cyan standingsCache += @s hitw_indvscore
execute as @a[team=orange] run scoreboard players operation orange standingsCache += @s hitw_indvscore
execute as @a[team=purple] run scoreboard players operation purple standingsCache += @s hitw_indvscore
execute as @a[team=pink] run scoreboard players operation pink standingsCache += @s hitw_indvscore
