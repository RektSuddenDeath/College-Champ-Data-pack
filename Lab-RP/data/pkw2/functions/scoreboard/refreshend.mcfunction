...
execute as @a[team=red] run scoreboard players operation red sbrank_target += @s pkw2_indvscore
execute as @a[team=blue] run scoreboard players operation blue sbrank_target += @s pkw2_indvscore
execute as @a[team=green] run scoreboard players operation green sbrank_target += @s pkw2_indvscore
execute as @a[team=yellow] run scoreboard players operation yellow sbrank_target += @s pkw2_indvscore
execute as @a[team=cyan] run scoreboard players operation cyan sbrank_target += @s pkw2_indvscore
execute as @a[team=orange] run scoreboard players operation orange sbrank_target += @s pkw2_indvscore
execute as @a[team=purple] run scoreboard players operation purple sbrank_target += @s pkw2_indvscore
execute as @a[team=pink] run scoreboard players operation pink sbrank_target += @s pkw2_indvscore
...
function pkw2:scoreboard/macro_position with storage temp_sbrank
