...
execute if score @s ar_laps matches 1 run function acerace4:checkpoint/disp_nt/0
execute if score @s ar_laps matches 2..4 run function acerace4:checkpoint/disp/0
