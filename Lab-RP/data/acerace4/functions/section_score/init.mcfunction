...
scoreboard players set 9 ar_secbests 2147483647
...
execute as @a[scores={ar_sec9time=1..},team=!spec] run scoreboard players operation 9 ar_secbests < @s ar_sec9time
...
execute as @a[team=!spec] if score @s ar_sec9time = 9 ar_secbests run tag @s add ar_champ_cp_9
...
scoreboard players operation 9 ar_besttimes_s = 9 ar_secbests
scoreboard players operation 9 ar_besttimes_ms = 9 ar_secbests
scoreboard players operation 9 ar_besttimes_s /= 100 math
scoreboard players operation 9 ar_besttimes_ms %= 100 math
execute if score 9 ar_besttimes_ms < 10 math run scoreboard players set 9 ar_besttimes_ms_z 0
