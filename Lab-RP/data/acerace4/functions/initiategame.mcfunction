...
forceload add -49981 -50005 -50004 -50000
...
tp @a -49993 101 -50005 0 0
#This starts the countdown & intro

# xp set @a 61 levels

function acerace4:intro/1b

schedule function acerace4:intro/1a 2s
schedule function acerace4:intro/2a 4s
schedule function acerace4:intro/3a 14s
schedule function acerace4:intro/4a 24s
schedule function acerace4:intro/5a 34s
schedule function acerace4:intro/6a 44s
...
function acerace4:scoreboard/init
function master:timer/starting/acerace
function acerace4:beginlistener
