...
execute if score round bb_game matches 7 run team modify placeholder_pu1 suffix "/7"

execute if score purple bb_wins matches 1 run team modify placeholder_pu1 prefix [{"text": "已获胜轮数: ","color": "green"},{"text": "1","color": "white"}]
execute if score purple bb_wins matches 2 run team modify placeholder_pu1 prefix [{"text": "已获胜轮数: ","color": "green"},{"text": "2","color": "white"}]
execute if score purple bb_wins matches 3 run team modify placeholder_pu1 prefix [{"text": "已获胜轮数: ","color": "green"},{"text": "3","color": "white"}]
execute if score purple bb_wins matches 4 run team modify placeholder_pu1 prefix [{"text": "已获胜轮数: ","color": "green"},{"text": "4","color": "white"}]
execute if score purple bb_wins matches 5 run team modify placeholder_pu1 prefix [{"text": "已获胜轮数: ","color": "green"},{"text": "5","color": "white"}]
execute if score purple bb_wins matches 6 run team modify placeholder_pu1 prefix [{"text": "已获胜轮数: ","color": "green"},{"text": "6","color": "white"}]
execute if score purple bb_wins matches 7 run team modify placeholder_pu1 prefix [{"text": "已获胜轮数: ","color": "green"},{"text": "7","color": "white"}]
...
# Transcript
tellraw @a[tag=_transcript] ["  §bTranscript >> §f紫队占领了中心点！"," §7[",{"score":{"name": "hour","objective": "_transcript"},"color": "gray"},"§7:",{"score":{"name": "minute_padding","objective": "_transcript"},"color": "gray"},{"score":{"name": "minute","objective": "_transcript"},"color": "gray"},"§7:",{"score":{"name": "second_padding","objective": "_transcript"},"color": "gray"},{"score":{"name": "second","objective": "_transcript"},"color": "gray"},"§7]"]
