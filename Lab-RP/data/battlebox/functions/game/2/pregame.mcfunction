...
execute as @a[tag=bb_noclear] run tellraw @s ["","§a§l使用了一次保留物品栏次数，剩余",{"score":{"name": "@s","objective": "bb_keepinv_stacks"},"color": "gold","bold": true},"§a§l次。"]
...
tp @a[team=green] -21 33 75 270 0
tp @a[team=blue] 21 33 150 90 0
tp @a[team=yellow] -21 33 150 270 0
tp @a[team=cyan] 21 33 225 90 0
tp @a[team=orange] -21 33 225 270 0
tp @a[team=pink] 21 33 300 90 0
tp @a[team=purple] -21 33 300 270 0

spawnpoint @a[team=red] 21 33 75
spawnpoint @a[team=green] -21 33 75
spawnpoint @a[team=blue] 21 33 150
spawnpoint @a[team=yellow] -21 33 150
spawnpoint @a[team=cyan] 21 33 225
spawnpoint @a[team=orange] -21 33 225
...
tp @e[type=marker,tag=bb_greenanchor] @e[type=marker,tag=bb_centeranchor,tag=a1,limit=1]
...
tp @e[type=marker,tag=bb_orangeanchor] @e[type=marker,tag=bb_centeranchor,tag=a3,limit=1]
tp @e[type=marker,tag=bb_purpleanchor] @e[type=marker,tag=bb_centeranchor,tag=a4,limit=1]

#region Play Texts
title @a times 10 40 10
title @a title "回合 2/7"
title @a[team=red] subtitle ["",{"text": "红队","color": "red"}," vs. ",{"text": "绿队","color": "green"}]
title @a[team=blue] subtitle ["",{"text": "蓝队","color": "blue"}," vs. ",{"text": "黄队","color": "yellow"}]
title @a[team=green] subtitle ["",{"text": "绿队","color": "green"}," vs. ",{"text": "红队","color": "red"}]
title @a[team=yellow] subtitle ["",{"text": "黄队","color": "yellow"}," vs. ",{"text": "蓝队","color": "blue"}]
title @a[team=cyan] subtitle ["",{"text": "青队","color":"dark_aqua"}," vs. ",{"text": "橙队","color":"gold"}]
title @a[team=pink] subtitle ["",{"text": "粉队","color":"light_purple"}," vs. ",{"text": "紫队","color": "dark_purple"}]
title @a[team=orange] subtitle ["",{"text": "橙队","color":"gold"}," vs. ",{"text": "青队","color":"dark_aqua"}]
title @a[team=purple] subtitle ["",{"text": "紫队","color": "dark_purple"}," vs. ",{"text": "粉队","color":"light_purple"}]
#endregion
...
function battlebox:scoreboard/game2
execute if score remix bb_game matches 0 run schedule function battlebox:game/2/ready 15s
execute if score remix bb_game matches 1 run schedule function battlebox:game/2/ready 25s
scoreboard objectives setdisplay below_name health
scoreboard players set completed bb_game 0
scoreboard players set round bb_game 2

function battlebox:statusbar/pregameinit

# Transcript
tellraw @a[tag=_transcript] ["  §bTranscript >> Round roster:"]
tellraw @a[tag=_transcript] ["  §bTranscript >> ","§c红队","§7 vs."," §a绿队"]
tellraw @a[tag=_transcript] ["  §bTranscript >> ","§e黄队","§7 vs."," §9蓝队"]
tellraw @a[tag=_transcript] ["  §bTranscript >> ","§3青队","§7 vs."," §6橙队"]
tellraw @a[tag=_transcript] ["  §bTranscript >> ","§d粉队","§7 vs."," §5紫队"]