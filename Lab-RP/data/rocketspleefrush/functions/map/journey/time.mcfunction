...
execute if score TimeElapsed rsr_game matches 0..60 run function rocketspleefrush:map/journey/split/0_60
execute if score TimeElapsed rsr_game matches 61..125 run function rocketspleefrush:map/journey/split/61_120
execute if score TimeElapsed rsr_game matches 120..180 run function rocketspleefrush:map/journey/split/121_180
execute if score TimeElapsed rsr_game matches 181.. run function rocketspleefrush:map/journey/split/181_240
...
execute if score gameflag rsr_game matches 1 run schedule function rocketspleefrush:map/journey/time 1s