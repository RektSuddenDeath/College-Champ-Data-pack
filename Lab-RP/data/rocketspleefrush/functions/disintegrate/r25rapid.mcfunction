...
execute if score progress rsr_disintegrate matches 1..125 run function rocketspleefrush:disintegrate/r25rapid
execute if score progress rsr_disintegrate matches 126 if score success rsr_disintegrate matches 1 run schedule function rocketspleefrush:disintegrate/r25rapid 1t
execute if score progress rsr_disintegrate matches 126 run scoreboard players set progress rsr_disintegrate 0