...
execute if score progress rsr_disintegrate matches 1..69 run function rocketspleefrush:disintegrate/r8rapid
execute if score progress rsr_disintegrate matches 70 if score success rsr_disintegrate matches 1 run schedule function rocketspleefrush:disintegrate/r8rapid 1t
execute if score progress rsr_disintegrate matches 70 run scoreboard players set progress rsr_disintegrate 0