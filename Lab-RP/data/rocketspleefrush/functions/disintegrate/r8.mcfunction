...
execute as @e[type=area_effect_cloud,tag=killarena_source] at @s store success score success rsr_disintegrate run spreadplayers ~ ~ 0 8 under 199 true @e[type=marker,tag=killarena]
...
execute if score progress rsr_disintegrate matches 1..19 run function rocketspleefrush:disintegrate/r8
execute if score progress rsr_disintegrate matches 20 if score success rsr_disintegrate matches 1 run schedule function rocketspleefrush:disintegrate/r8 1t
