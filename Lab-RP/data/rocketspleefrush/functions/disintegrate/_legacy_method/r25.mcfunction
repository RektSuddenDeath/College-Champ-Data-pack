...
execute if score progress rsr_disintegrate matches 1..17 run function rocketspleefrush:disintegrate/r25
execute if score progress rsr_disintegrate matches 18 if score success rsr_disintegrate matches 1 run schedule function rocketspleefrush:disintegrate/r25 1t
execute if score progress rsr_disintegrate matches 18 run scoreboard players set progress rsr_disintegrate 0