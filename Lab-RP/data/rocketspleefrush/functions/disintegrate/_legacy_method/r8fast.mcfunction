...
execute if score progress rsr_disintegrate matches 1..99 run function rocketspleefrush:disintegrate/r8fast
execute if score progress rsr_disintegrate matches 100 if score success rsr_disintegrate matches 1 run schedule function rocketspleefrush:disintegrate/r8fast 1t
execute if score progress rsr_disintegrate matches 100 run scoreboard players set progress rsr_disintegrate 0