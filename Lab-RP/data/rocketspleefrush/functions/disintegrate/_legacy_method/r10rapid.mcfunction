...
execute as @e[type=area_effect_cloud,tag=killarena_source] at @s store success score success rsr_disintegrate run spreadplayers ~ ~ 0 10 under 300 true @e[type=marker,tag=killarena]
...
execute if score progress rsr_disintegrate matches 1..79 run function rocketspleefrush:disintegrate/r10rapid
execute if score progress rsr_disintegrate matches 80 if score success rsr_disintegrate matches 1 run schedule function rocketspleefrush:disintegrate/r10rapid 1t
execute if score progress rsr_disintegrate matches 80 run scoreboard players set progress rsr_disintegrate 0