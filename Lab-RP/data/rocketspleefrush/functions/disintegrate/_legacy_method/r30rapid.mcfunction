...
execute if score progress rsr_disintegrate matches 1..90 run function rocketspleefrush:disintegrate/r30fast
execute if score progress rsr_disintegrate matches 91 if score success rsr_disintegrate matches 1 run schedule function rocketspleefrush:disintegrate/r30fast 1t
execute if score progress rsr_disintegrate matches 91 run scoreboard players set progress rsr_disintegrate 0