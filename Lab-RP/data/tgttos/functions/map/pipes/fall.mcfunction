...
tag @a[team=!spec,gamemode=adventure,scores={temp_playerY=..83}] add fallen

tp @a[tag=fallen] -5999 100 -8000 90 0
...
execute if score gameflag tgttos_game matches 1 run schedule function tgttos:map/pipes/fall 1t