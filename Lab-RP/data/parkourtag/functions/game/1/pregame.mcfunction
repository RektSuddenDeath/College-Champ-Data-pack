...
tp @a[team=blue] -2520.5 105.00 -2199.5 -90 0
tp @a[team=green] -2478.5 105.00 -2399.5 90 0
...
function parkourtag:scoreboard/game1
schedule function parkourtag:game/1/ready 15s
scoreboard objectives setdisplay below_name
scoreboard players set completed pkt_game 0
scoreboard players set round pkt_game 1
