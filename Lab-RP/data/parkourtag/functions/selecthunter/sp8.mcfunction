...
execute if score @s pkt_hunts < maxhunts pkt_hunts run setblock -2526 106 -2800 air
execute if score @s pkt_hunts < maxhunts pkt_hunts run fill -2524 105 -2800 -2524 107 -2800 minecraft:red_stained_glass_pane
execute if score @s pkt_hunts < maxhunts pkt_hunts run tp @p[tag=hunter] -2525 105 -2800
