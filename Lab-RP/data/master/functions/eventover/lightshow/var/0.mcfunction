...
scoreboard players set @e[type=area_effect_cloud,tag=f1] LightShow 8
scoreboard players set @e[type=area_effect_cloud,tag=f2] LightShow 8
scoreboard players set @e[type=area_effect_cloud,tag=f3] LightShow 8
