...
scoreboard players set gamecount bb_game 1
...
function battlebox:initiategame
...
scoreboard players set 2 dd_games 1
scoreboard players set ActiveGame tourney_stats 2
