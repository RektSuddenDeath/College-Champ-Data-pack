...
forceload add -7900 -7900 -8100 -8100
tp @a -8000 100 -8000

function rocketspleefrush:initiategame
...
scoreboard players set 9 dd_games 1
scoreboard players set ActiveGame tourney_stats 9
