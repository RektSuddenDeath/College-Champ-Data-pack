...
effect clear @a
clear @a
execute in sg:sjtu run gamerule fallDamage false
execute in sg:sjtu run gamerule naturalRegeneration true
execute in sg:sjtu run gamerule doTileDrops false
execute in sg:sjtu run gamerule doImmediateRespawn false
execute in sg:sjtu run gamerule mobGriefing false
execute in sg:sjtu run difficulty easy
execute in sg:sjtu run gamerule keepInventory true
...
execute in sg:sjtu run time set day
...
scoreboard players set 13 dd_games 1
scoreboard players set ActiveGame tourney_stats 13
