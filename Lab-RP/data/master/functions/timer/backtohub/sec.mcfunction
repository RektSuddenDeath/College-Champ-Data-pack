...
#
execute if score second master.timer matches 0.. if score minute master.timer matches 5 run team modify timer prefix [{"text":"返回大厅: ","color":"red"},{"text":"5","color":"white"}]
execute if score second master.timer matches 0.. if score minute master.timer matches 4 run team modify timer prefix [{"text":"返回大厅: ","color":"red"},{"text":"4","color":"white"}]
execute if score second master.timer matches 0.. if score minute master.timer matches 3 run team modify timer prefix [{"text":"返回大厅: ","color":"red"},{"text":"3","color":"white"}]
execute if score second master.timer matches 0.. if score minute master.timer matches 2 run team modify timer prefix [{"text":"返回大厅: ","color":"red"},{"text":"2","color":"white"}]
execute if score second master.timer matches 0.. if score minute master.timer matches 1 run team modify timer prefix [{"text":"返回大厅: ","color":"red"},{"text":"1","color":"white"}]
execute if score second master.timer matches 0.. if score minute master.timer matches 0 run team modify timer prefix [{"text":"返回大厅: ","color":"red"},{"text":"0","color":"white"}]
...
execute if score second master.timer matches 0.. if score minute master.timer matches 0.. run schedule function master:timer/backtohub/sec 1s
execute if score second master.timer matches 0 if score minute master.timer matches 0 if score ActiveGame tourney_stats matches 10 run function master:eventover/initiate
execute if score second master.timer matches 0 if score minute master.timer matches 0 unless score ActiveGame tourney_stats matches 10 run function master:tohub
