...
scoreboard players add green bm_goldencomps 1
...
tellraw @a[team=!green] ["","§2绿队","§7第",{"score":{"name": "@s","objective": "bm_compNo"},"color": "yellow"},"§7个完成了","§6黄金建筑 #",{"score":{"name": "@s","objective": "bm_plotNo"},"color":"gold"}]
tellraw @a[team=green] ["[§6+§r",{"score":{"name": "@s","objective": "bm_earnScore"},"color": "gold"},"§6分§f] ","§7你","§7第",{"score":{"name": "@s","objective": "bm_compNo"},"color": "yellow"},"§7个完成了","§6黄金建筑 #",{"score":{"name": "@s","objective": "bm_plotNo"},"color":"gold"}]
...
execute as @e[type=marker,tag=zone_right,tag=green] run scoreboard players operation @s bm_rightplotNo = green bm_goldencomps
execute as @e[type=marker,tag=zone_right,tag=green] run scoreboard players operation @s bm_rightplotNo += 1 math

execute as @e[type=marker,tag=zone_right,tag=green,tag=bm_example,limit=1,sort=nearest] at @s run function buildmart:copy/find_golden
