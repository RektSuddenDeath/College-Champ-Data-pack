...
scoreboard players add blue bm_goldencomps 1
...
tellraw @a[team=!blue] ["","§9蓝队","§7第",{"score":{"name": "@s","objective": "bm_compNo"},"color": "yellow"},"§7个完成了","§6黄金建筑 #",{"score":{"name": "@s","objective": "bm_plotNo"},"color":"gold"}]
tellraw @a[team=blue] ["[§6+§r",{"score":{"name": "@s","objective": "bm_earnScore"},"color": "gold"},"§6分§f] ","§7你","§7第",{"score":{"name": "@s","objective": "bm_compNo"},"color": "yellow"},"§7个完成了","§6黄金建筑 #",{"score":{"name": "@s","objective": "bm_plotNo"},"color":"gold"}]
...
execute as @e[type=marker,tag=zone_right,tag=blue] run scoreboard players operation @s bm_rightplotNo = blue bm_goldencomps
execute as @e[type=marker,tag=zone_right,tag=blue] run scoreboard players operation @s bm_rightplotNo += 1 math

execute as @e[type=marker,tag=zone_right,tag=bm_example,tag=blue,limit=1,sort=nearest] at @s run function buildmart:copy/find_golden
