...
execute if score progress rsr_disintegrate matches 1..12 run function rocketspleefrush:disintegrate/r30slow
execute if score progress rsr_disintegrate matches 13 if score success rsr_disintegrate matches 1 run schedule function rocketspleefrush:disintegrate/r30slow 1t
execute if score progress rsr_disintegrate matches 13 run scoreboard players set progress rsr_disintegrate 0