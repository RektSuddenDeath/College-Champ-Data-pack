...
execute if score progress rsr_disintegrate matches 1..30 run function rocketspleefrush:disintegrate/r25fast
execute if score progress rsr_disintegrate matches 31 if score success rsr_disintegrate matches 1 run schedule function rocketspleefrush:disintegrate/r25fast 1t
execute if score progress rsr_disintegrate matches 31 run scoreboard players set progress rsr_disintegrate 0