...
execute if score progress rsr_disintegrate matches 1..19 run function rocketspleefrush:disintegrate/r10
execute if score progress rsr_disintegrate matches 20 if score success rsr_disintegrate matches 1 run schedule function rocketspleefrush:disintegrate/r10 1t
