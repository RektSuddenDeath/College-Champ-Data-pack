...
execute as @e[type=area_effect_cloud,tag=killarena_source] at @s store success score success rsr_disintegrate run spreadplayers ~ ~ 0 15 under 300 true @e[type=marker,tag=killarena]
...
execute if score progress rsr_disintegrate matches 1..159 run function rocketspleefrush:disintegrate/r15fast
execute if score progress rsr_disintegrate matches 160 if score success rsr_disintegrate matches 1 run schedule function rocketspleefrush:disintegrate/r15fast 1t
execute if score progress rsr_disintegrate matches 160 run scoreboard players set progress rsr_disintegrate 0