...
execute store result storage rsr:map_reg island_no int 1 run scoreboard players get arrow rsr_map_register_global
data modify storage rsr:map_reg type set value "arrow"
