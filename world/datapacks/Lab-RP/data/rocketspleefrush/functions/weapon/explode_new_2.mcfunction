...
execute positioned ~ ~ ~ as @e[type=marker,tag=rsr_player_position_record,distance=..1.3] run function rocketspleefrush:durability/marker_struck_attached with storage rsr:temp_attack
# execute positioned ~-0.65 ~-0.65 ~-0.65 as @a[gamemode=!spectator,dx=1.3,dy=1.3,dz=1.3] at @s run function rocketspleefrush:durability/direct_hit_victim
