...
execute if score second master.timer matches 2 run schedule function acerace2:start 1s

execute unless score second master.timer matches 1 run schedule function acerace2:intro/11a 1s