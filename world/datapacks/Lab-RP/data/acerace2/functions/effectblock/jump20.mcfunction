execute as @a[nbt={OnGround:1b}] at @s if block ~ ~-1 ~ raw_gold_block run effect give @s jump_boost 1 19 true
...
execute if score gameflag ar_game matches 1 run schedule function acerace2:effectblock/jump20 2t