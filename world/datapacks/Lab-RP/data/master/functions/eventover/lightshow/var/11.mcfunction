...
scoreboard players set @e[type=area_effect_cloud,tag=f4] LightShow 1
scoreboard players set @e[type=area_effect_cloud,tag=f5] LightShow 1
scoreboard players set @e[type=area_effect_cloud,tag=f6] LightShow 1
scoreboard players set @e[type=area_effect_cloud,tag=f7] LightShow 1
scoreboard players set @e[type=area_effect_cloud,tag=f8] LightShow 1

scoreboard players set @e[type=area_effect_cloud,tag=f9] LightShow 1
scoreboard players set @e[type=area_effect_cloud,tag=f10] LightShow 8
scoreboard players set @e[type=area_effect_cloud,tag=f11] LightShow 8
scoreboard players set @e[type=area_effect_cloud,tag=f12] LightShow 8
scoreboard players set @e[type=area_effect_cloud,tag=f13] LightShow 8
scoreboard players set @e[type=area_effect_cloud,tag=f14] LightShow 8
