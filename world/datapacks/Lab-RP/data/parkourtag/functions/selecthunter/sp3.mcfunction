...
execute if score @s pkt_hunts < maxhunts pkt_hunts run setblock -2474 106 -2400 air
execute if score @s pkt_hunts < maxhunts pkt_hunts run fill -2476 105 -2400 -2476 107 -2400 minecraft:red_stained_glass_pane
execute if score @s pkt_hunts < maxhunts pkt_hunts run tp @p[tag=hunter] -2475 105 -2400
