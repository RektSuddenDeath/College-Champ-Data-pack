...
tellraw @a[team=blue] " "
tellraw @a[team=blue] "  §e类似的，宝库也需要§l特殊的钥匙§r§e打开。"
tellraw @a[team=blue] "  宝库钥匙所在之处各具有不同的性质。"
tellraw @a[team=blue] " "
tellraw @a[team=blue] "  如：§c红色钥匙§r总是在一个解密后方。"
tellraw @a[team=blue] " "
tellraw @a[team=blue] "  §c§l教程任务：§r获取§c红色钥匙"
tellraw @a[team=blue] " "
tellraw @a[team=blue] [{"color":"green","text":"———————————————————————————————————"}]
