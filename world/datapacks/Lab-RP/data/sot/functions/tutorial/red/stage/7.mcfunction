...
tellraw @a[team=red] " "
tellraw @a[team=red] "  §e类似的，宝库也需要§l特殊的钥匙§r§e打开。"
tellraw @a[team=red] "  宝库钥匙所在之处各具有不同的性质。"
tellraw @a[team=red] " "
tellraw @a[team=red] "  如：§c红色钥匙§r总是在一个解密后方。"
tellraw @a[team=red] " "
tellraw @a[team=red] "  §c§l教程任务：§r获取§c红色钥匙"
tellraw @a[team=red] " "
tellraw @a[team=red] [{"color":"green","text":"———————————————————————————————————"}]
