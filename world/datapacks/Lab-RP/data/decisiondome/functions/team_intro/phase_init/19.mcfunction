...
schedule clear decisiondome:team_intro/phase_loop/18
tag @a[team=pink] add team_intro_tp
effect clear @a[team=cyan] invisibility
effect clear @a[team=pink] invisibility
...
title @a title ["§d§l粉队"]
title @a subtitle [{"selector":"@a[team=pink]"}] 
title @a times 5 30 5

tellraw @a ""
tellraw @a ["§d粉队: ",{"selector":"@a[team=pink]"}]