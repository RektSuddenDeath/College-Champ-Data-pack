...
schedule clear decisiondome:team_intro/phase_loop/20
tag @a[team=orange] add team_intro_tp
...
title @a title ["§6§l橙队"]
title @a subtitle [{"selector":"@a[team=orange]"}] 
title @a times 5 30 5

tellraw @a ""
tellraw @a ["§6橙队: ",{"selector":"@a[team=orange]"}]