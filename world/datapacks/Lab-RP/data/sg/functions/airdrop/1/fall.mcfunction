...
scoreboard players set airdropValue sg_game 60
scoreboard players set airdropNo sg_game 1

tag @e[type=marker,tag=sg_airdrop] remove airdrop_selected
tag @e[type=marker,tag=airdrop_1,limit=1,sort=random] add airdrop_selected
