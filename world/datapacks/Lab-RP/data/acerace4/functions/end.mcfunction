...
tellraw @a "§6即将进行积分结算……"
tellraw @a ""
function acerace4:section_score/init

schedule function acerace4:text/section_champions 2s
schedule function acerace4:section_score/champions 4s
schedule function acerace4:text/section_scores 12s
schedule function acerace4:section_score/1 280t
schedule function acerace4:section_score/2 290t
schedule function acerace4:section_score/3 300t
schedule function acerace4:section_score/4 310t
schedule function acerace4:section_score/5 320t
schedule function acerace4:section_score/6 330t
schedule function acerace4:section_score/7 340t
schedule function acerace4:section_score/8 350t
schedule function acerace4:section_score/9 360t
schedule function acerace4:section_score/cleanup 361t

schedule function utils:text/gamescore 26s
schedule function utils:text/fastestgame 34s
schedule function acerace4:mvpannouncement 36s
schedule function utils:text/fastestlap 44s
schedule function acerace4:flapdec 46s
