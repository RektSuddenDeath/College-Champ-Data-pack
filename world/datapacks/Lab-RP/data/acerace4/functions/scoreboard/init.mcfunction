...
team modify placeholder_7 suffix [{"text":"地图: ","color":"aqua"},{"text":"Frostbite   ","color":"white","bold":false}]
team modify placeholder_8 suffix "§8Casual"
execute if score eventmode tourney_stats matches 1 run function acerace4:scoreboard/macro_gameline with storage master:event_status
