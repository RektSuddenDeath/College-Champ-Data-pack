...
# Champions
execute as @a[tag=ar_champ_cp_1] run tellraw @s ["  区域§b1: ",{"score":{"name": "@s","objective": "ar_sect_score_s"},"color": "gold"},"§6.",{"score":{"name": "@s","objective": "ar_sect_score_ms_z"},"color": "gold"},{"score":{"name": "@s","objective": "ar_sect_score_ms"},"color": "gold"},"§6s"," §e§l#1! "," §6[§6+",{"score":{"name": "first_score","objective": "ar_sec_factors"},"color": "gold"},"§6分]"]
