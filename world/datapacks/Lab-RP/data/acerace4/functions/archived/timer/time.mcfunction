...
execute if score endtime ar_time matches 0 run function acerace4:end
execute if score minute master.timer matches 0 if score second master.timer matches 0 run function acerace4:end
execute if score gameflag ar_game matches 1 run schedule function acerace4:timer/time 1s
