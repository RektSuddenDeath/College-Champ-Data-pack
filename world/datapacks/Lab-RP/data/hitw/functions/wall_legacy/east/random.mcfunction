...
execute unless score prevwall hitw_wall = wall hitw_wall run function hitw:wall/east/wall
execute if score prevwall hitw_wall = wall hitw_wall run function hitw:wall/east/random
