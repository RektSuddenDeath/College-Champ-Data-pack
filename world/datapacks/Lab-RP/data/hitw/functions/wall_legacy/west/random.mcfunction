...
execute unless score prevwall hitw_wall = wall hitw_wall run function hitw:wall/west/wall
execute if score prevwall hitw_wall = wall hitw_wall run function hitw:wall/west/random
