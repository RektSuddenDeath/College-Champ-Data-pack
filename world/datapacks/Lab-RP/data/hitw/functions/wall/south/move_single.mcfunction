...
execute if score @s hitw_wall_ctrl >= total_steps hitw_wall_ctrl run setblock ~-6 ~1 ~-1 air destroy
execute if score @s hitw_wall_ctrl >= total_steps hitw_wall_ctrl run setblock ~-7 ~3 ~-1 air destroy
execute if score @s hitw_wall_ctrl >= total_steps hitw_wall_ctrl run setblock ~-8 ~5 ~-1 air destroy
...
execute run clone ~-13 ~ ~1 ~ ~5 ~1 ~-13 ~ ~
execute run fill ~-13 ~ ~1 ~ ~5 ~1 warped_button[face=wall,facing=south,powered=true] replace piston
execute run tp @s ~ ~ ~-1