...
schedule clear tgttos:map/glide/fall
schedule clear tgttos:map/glide/noplace

forceload add -6431 -6512 -6505 -6481
schedule function tgttos:map/glide/cleanup 10s

# function master:timer/nextround/10s
# schedule function tgttos:map/doors/initiate 10s
