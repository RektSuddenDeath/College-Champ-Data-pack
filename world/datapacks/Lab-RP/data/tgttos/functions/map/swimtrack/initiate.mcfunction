...
scoreboard players set map tgttos_game 13


# Scoreboard
team modify placeholder_4 suffix "Swimtrack §7by Grassbl0ck"
...
tp @a[team=red] -7017 99 -8006 180 0
tp @a[team=blue] -7012 99 -8006 180 0
tp @a[team=green] -7007 99 -8006 180 0
tp @a[team=yellow] -7002 99 -8006 180 0
tp @a[team=cyan] -6997 99 -8006 180 0
tp @a[team=pink] -6992 99 -8006 180 0
tp @a[team=orange] -6987 99 -8006 180 0
tp @a[team=purple] -6982 99 -8006 180 0
tp @a[team=spec] -6974 104 -8019 90 0
spawnpoint @a -7000 99 -8006 180
fill -6981 102 -8014 -7019 99 -8014 barrier
...
execute if score feed_mode_active tgttos_game matches 0 run execute as @a[team=!spec] run summon chicken -7000 72 -8281 {Health:100,active_effects:[{id:"speed",amplifier:99,duration:80}]}
execute if score feed_mode_active tgttos_game matches 1 run execute as @a[team=!spec] run summon chicken -7000 72 -8281 {Health:100,active_effects:[{id:"speed",amplifier:99,duration:80}],Invulnerable:1b}
...
schedule function tgttos:map/swimtrack/start 20s

# Avoids spawn placing until game is on
function tgttos:map/swimtrack/noplace
