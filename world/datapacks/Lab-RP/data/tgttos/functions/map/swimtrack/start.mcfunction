...
fill -6981 102 -8014 -7019 99 -8014 air
title @a title ""
title @a subtitle ""
team modify placeholder_4 suffix "Swimtrack"
# Start Detecting kills
function tgttos:detect
# function tgttos:map/swimtrack/fall
...
# noplace
schedule clear tgttos:map/swimtrack/noplace
function tgttos:map/swimtrack/spawnprot