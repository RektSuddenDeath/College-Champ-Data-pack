...
# Get rid of barrier
fill -11502 104 -11510 -11499 101 -11490 air

title @a title ""
title @a subtitle ""
# Start Detecting kills
function tgttos:detect
function tgttos:map/racetrack/fall
...
# noplace
schedule clear tgttos:map/racetrack/noplace
function tgttos:map/racetrack/spawnprot