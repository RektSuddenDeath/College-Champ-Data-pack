...
# Round/1
execute if score minute master.timer matches 4 if score second master.timer matches 20 run function meltdown:map_update/round_1/1
...
execute if score minute master.timer matches 3 if score second master.timer matches 30 run function meltdown:map_update/round_1/2
...
execute if score minute master.timer matches 2 if score second master.timer matches 40 run function meltdown:map_update/round_1/3
...
execute if score minute master.timer matches 2 if score second master.timer matches 10 run function meltdown:map_update/round_1/4
...
execute if score minute master.timer matches 1 if score second master.timer matches 50 run function meltdown:map_update/round_1/5
...
execute if score minute master.timer matches 1 if score second master.timer matches 20 run function meltdown:map_update/round_1/6
...
execute if score gameflag meltdown_game matches 1 run schedule function meltdown:time/round_1 1s