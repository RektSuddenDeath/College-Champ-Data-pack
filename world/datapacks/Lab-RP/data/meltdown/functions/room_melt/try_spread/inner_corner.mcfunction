...
execute if score @s meltdown_melt_point_random <= inner_corner meltdown_melt_point_spread_chance run execute positioned ~ ~1 ~ run function meltdown:room_melt/try_spread/block_valid/inner_corner
...
execute store result score @s meltdown_melt_point_random run random value 1..10
execute if score @s meltdown_melt_point_random <= inner_corner meltdown_melt_point_spread_chance run execute positioned ~1 ~ ~-1 run function meltdown:room_melt/try_spread/block_valid/inner_corner
...
execute store result score @s meltdown_melt_point_random run random value 1..10
execute if score @s meltdown_melt_point_random <= inner_corner meltdown_melt_point_spread_chance run execute positioned ~1 ~1 ~-1 run function meltdown:room_melt/try_spread/block_valid/inner_corner
