...
# Inner Corners
execute positioned 60956 302 60422 run place template meltdown:map/melted ~80 ~ ~80
execute positioned 60956 302 60422 run place template meltdown:map/melted ~200 ~ ~80
execute positioned 60956 302 60422 run place template meltdown:map/melted ~80 ~ ~200
execute positioned 60956 302 60422 run place template meltdown:map/melted ~200 ~ ~200
# Central Core
execute positioned 60956 302 60422 run place template meltdown:map/melting ~140 ~ ~140
