...
execute as @e[type=minecraft:area_effect_cloud,tag=gr_orangeanchor] at @s run fill ~14 101 ~16 ~14 101 ~14 air
...
# Announce position
tellraw @a[team=!orange] ["",{"translate":"team.orange"},"§7第",{"score":{"name": "3","objective": "gr_indvroom"},"color": "aqua"},"§7个完成了房间","§e[","§bIce and Fire","§e]"]
tellraw @a[team=orange] ["","§7你","§7第",{"score":{"name": "3","objective": "gr_indvroom"},"color": "aqua"},"§7个完成了房间","§e[","§bIce and Fire","§e]"]
# Initiate next room
