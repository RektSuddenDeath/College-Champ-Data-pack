...
# Modify scoreboard
scoreboard players display name var_room_name gr_cyansb "§a§l当前房间: §rHoneycomb"
...
# Give items
clear @a[team=cyan]
give @a[team=cyan] shears{CanDestroy:[magenta_wool,purple_wool,green_wool,cyan_wool],Unbreakable:1b}
