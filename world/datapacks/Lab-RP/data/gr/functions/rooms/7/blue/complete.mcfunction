...
execute as @e[type=minecraft:area_effect_cloud,tag=gr_blueanchor] at @s run fill ~7 101 ~7 ~7 104 ~9 air
execute as @e[type=minecraft:area_effect_cloud,tag=gr_blueanchor] at @s run fill ~7 101 ~23 ~7 104 ~25 air
...
# Announce position
tellraw @a[team=!blue] ["",{"translate":"team.blue"},"§7第",{"score":{"name": "7","objective": "gr_indvroom"},"color": "aqua"},"§7个完成了房间","§e[","§6Honeycomb","§e]"]
tellraw @a[team=blue] ["","§7你","§7第",{"score":{"name": "7","objective": "gr_indvroom"},"color": "aqua"},"§7个完成了房间","§e[","§6Honeycomb","§e]"]
# Initiate next room
