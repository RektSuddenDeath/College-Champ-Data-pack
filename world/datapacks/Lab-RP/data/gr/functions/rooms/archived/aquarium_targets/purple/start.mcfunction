...
# Modify scoreboard
scoreboard players display name var_room_name gr_purplesb "§a§l当前房间: §rAquarium Targets"
...
title @a[team=purple] title "§e射击全部标靶！"
# Give items
clear @a[team=purple]
give @a[team=purple] trident{Enchantments:[{id:"loyalty",lvl:3}],Unbreakable:1b} 2
