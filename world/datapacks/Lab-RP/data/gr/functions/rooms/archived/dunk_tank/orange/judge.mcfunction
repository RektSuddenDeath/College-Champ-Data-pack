...
execute as @e[type=area_effect_cloud,tag=gr_orangeanchor] at @s if block ~3 ~7 ~17 hopper{Items:[{Slot:0b,id:"minecraft:gold_block"}]} run scoreboard players add 1 gr_orangeobj 1
