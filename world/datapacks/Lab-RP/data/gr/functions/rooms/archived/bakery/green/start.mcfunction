...
# Modify scoreboard
scoreboard players display name var_room_name gr_greensb "§a§l当前房间: §rBakery"
...
title @a[team=green] title "§e吃掉全部蛋糕！"
# Give items
clear @a[team=green]
effect clear @a[team=green] saturation
effect give @a[team=green] hunger infinite 255 true
