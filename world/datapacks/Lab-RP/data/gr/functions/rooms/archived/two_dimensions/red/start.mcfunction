...
# Modify scoreboard
scoreboard players display name var_room_name gr_redsb "§a§l当前房间: §rTwo Dimensions"
...
title @a[team=red] title "§e收集所需物品！"
# Give items
clear @a[team=red]
recipe give @a[team=red] comparator
recipe give @a[team=red] clock
# 开始计时
