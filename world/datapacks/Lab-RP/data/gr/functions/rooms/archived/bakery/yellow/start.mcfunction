...
# Modify scoreboard
scoreboard players display name var_room_name gr_yellowsb "§a§l当前房间: §rBakery"
...
title @a[team=yellow] title "§e吃掉全部蛋糕！"
# Give items
clear @a[team=yellow]
effect clear @a[team=yellow] saturation
effect give @a[team=yellow] hunger infinite 255 true
