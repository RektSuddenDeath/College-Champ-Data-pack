...
# Restore Effects
effect clear @a[team=orange] hunger
effect give @a[team=orange] saturation infinite 7 true

# Announce position
tellraw @a[team=!orange] ["",{"translate":"team.orange"},"§7第",{"score":{"name": "1","objective": "gr_indvroom"},"color": "aqua"},"§7个完成了房间","§e[","§dBakery","§e]"]
tellraw @a[team=orange] ["","§7你","§7第",{"score":{"name": "1","objective": "gr_indvroom"},"color": "aqua"},"§7个完成了房间","§e[","§dBakery","§e]"]
# Initiate next room
