...
# Modify scoreboard
scoreboard players display name var_room_name gr_cyansb "§a§l当前房间: §rArt Gallery"
...
# Give items
clear @a[team=cyan]
give @a[team=cyan] iron_pickaxe{CanDestroy:[diamond_block,emerald_block,gold_block,lapis_block,waxed_oxidized_cut_copper],Unbreakable:1b} 1
