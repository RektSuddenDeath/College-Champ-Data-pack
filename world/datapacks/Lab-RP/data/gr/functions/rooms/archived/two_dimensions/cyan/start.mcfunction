...
# Modify scoreboard
scoreboard players display name var_room_name gr_cyansb "§a§l当前房间: §rTwo Dimensions"
...
title @a[team=cyan] title "§e收集所需物品！"
# Give items
clear @a[team=cyan]
recipe give @a[team=cyan] comparator
recipe give @a[team=cyan] clock
# 开始计时
