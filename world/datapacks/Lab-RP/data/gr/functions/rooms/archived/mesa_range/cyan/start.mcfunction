...
# Modify scoreboard
scoreboard players display name var_room_name gr_cyansb "§a§l当前房间: §rMesa Range"
...
title @a[team=cyan] title "§e击碎所有陶罐！"
# Give items
clear @a[team=cyan]
give @a[team=cyan] bow{Unbreakable:1b} 3
give @a[team=cyan] arrow 192
# 开始计时
