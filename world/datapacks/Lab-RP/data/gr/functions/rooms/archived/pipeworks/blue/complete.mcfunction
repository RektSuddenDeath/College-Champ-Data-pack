...
execute as @e[type=minecraft:area_effect_cloud,tag=gr_blueanchor] at @s run fill ~8 101 ~22 ~8 104 ~24 air
execute as @e[type=minecraft:area_effect_cloud,tag=gr_blueanchor] at @s run fill ~8 101 ~6 ~8 104 ~8 air
...
# Announce position
tellraw @a[team=!blue] ["",{"translate":"team.blue"},"§7第",{"score":{"name": "8","objective": "gr_indvroom"},"color": "aqua"},"§7个完成了房间","§e[","§fPipeworks","§e]"]
tellraw @a[team=blue] ["","§7你","§7第",{"score":{"name": "8","objective": "gr_indvroom"},"color": "aqua"},"§7个完成了房间","§e[","§fPipeworks","§e]"]
# Initiate next room
