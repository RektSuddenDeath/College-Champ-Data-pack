...
# Modify scoreboard
scoreboard players display name var_room_name gr_greensb "§a§l当前房间: §rMesa Range"
...
title @a[team=green] title "§e击碎所有陶罐！"
# Give items
clear @a[team=green]
give @a[team=green] bow{Unbreakable:1b} 3
give @a[team=green] arrow 192
# 开始计时
