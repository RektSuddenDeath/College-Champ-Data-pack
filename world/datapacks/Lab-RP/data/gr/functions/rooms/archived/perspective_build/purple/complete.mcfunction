...
# Save times
scoreboard players operation @e[type=area_effect_cloud,tag=gr_general,tag=gr_purpleany] gr_room6time = purple gr_currenttime
# Trim
...
scoreboard players operation purple gr_currentpos = 6 gr_indvroom
function gr:scoreboard/calc

# Announce position
tellraw @a[team=!purple] ["",{"translate":"team.purple"},"§7第",{"score":{"name": "6","objective": "gr_indvroom"},"color": "aqua"},"§7个完成了房间","§e[","§dPerspective Build","§e]"]
tellraw @a[team=purple] ["","§7你","§7第",{"score":{"name": "6","objective": "gr_indvroom"},"color": "aqua"},"§7个完成了房间","§e[","§dPerspective Build","§e]"]
# Initiate next room
...
function gr:rooms/7/purple/divider
function gr:rooms/7/purple/master
