...
execute as @e[type=minecraft:area_effect_cloud,tag=gr_cyananchor] at @s run fill ~5 101 ~2 ~5 104 ~28 air replace cobblestone_wall
execute as @e[type=minecraft:area_effect_cloud,tag=gr_cyananchor] at @s run fill ~5 101 ~2 ~5 104 ~28 air replace smooth_stone_slab
...
# Announce position
tellraw @a[team=!cyan] ["",{"translate":"team.cyan"},"§7第",{"score":{"name": "1","objective": "gr_indvroom"},"color": "aqua"},"§7个完成了房间","§e[","§dArt Gallery","§e]"]
tellraw @a[team=cyan] ["","§7你","§7第",{"score":{"name": "1","objective": "gr_indvroom"},"color": "aqua"},"§7个完成了房间","§e[","§dArt Gallery","§e]"]
# Initiate next room
