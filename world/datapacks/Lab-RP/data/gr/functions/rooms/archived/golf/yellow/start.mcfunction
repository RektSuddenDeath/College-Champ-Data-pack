...
# Modify scoreboard
scoreboard players display name var_room_name gr_yellowsb "§a§l当前房间: §rGolf"
...
title @a[team=yellow] title "§e将你的队友射入洞中！"
# Give items
clear @a[team=yellow]
give @a[team=yellow] stick{Enchantments:[{id:"knockback",lvl:2}]}
