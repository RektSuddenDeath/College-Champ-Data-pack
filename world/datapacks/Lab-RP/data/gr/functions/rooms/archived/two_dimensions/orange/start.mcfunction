...
# Modify scoreboard
scoreboard players display name var_room_name gr_orangesb "§a§l当前房间: §rTwo Dimensions"
...
title @a[team=orange] title "§e收集所需物品！"
# Give items
clear @a[team=orange]
recipe give @a[team=orange] comparator
recipe give @a[team=orange] clock
# 开始计时
