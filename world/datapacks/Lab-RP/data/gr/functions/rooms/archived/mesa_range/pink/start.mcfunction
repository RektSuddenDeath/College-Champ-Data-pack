...
# Modify scoreboard
scoreboard players display name var_room_name gr_pinksb "§a§l当前房间: §rMesa Range"
...
title @a[team=pink] title "§e击碎所有陶罐！"
# Give items
clear @a[team=pink]
give @a[team=pink] bow{Unbreakable:1b} 3
give @a[team=pink] arrow 192
# 开始计时
