...
# Modify scoreboard
scoreboard players display name var_room_name gr_redsb "§a§l当前房间: §rGolf"
...
title @a[team=red] title "§e将你的队友射入洞中！"
# Give items
clear @a[team=red]
give @a[team=red] stick{Enchantments:[{id:"knockback",lvl:2}]}
