...
# Restore Effects
effect clear @a[team=yellow] hunger
effect give @a[team=yellow] saturation infinite 7 true

# Announce position
tellraw @a[team=!yellow] ["",{"translate":"team.yellow"},"§7第",{"score":{"name": "1","objective": "gr_indvroom"},"color": "aqua"},"§7个完成了房间","§e[","§dBakery","§e]"]
tellraw @a[team=yellow] ["","§7你","§7第",{"score":{"name": "1","objective": "gr_indvroom"},"color": "aqua"},"§7个完成了房间","§e[","§dBakery","§e]"]
# Initiate next room
