...
# Modify scoreboard
scoreboard players display name var_room_name gr_greensb "§a§l当前房间: §rGolf"
...
title @a[team=green] title "§e将你的队友射入洞中！"
# Give items
clear @a[team=green]
give @a[team=green] stick{Enchantments:[{id:"knockback",lvl:2}]}
