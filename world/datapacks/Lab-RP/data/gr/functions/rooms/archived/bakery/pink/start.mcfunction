...
# Modify scoreboard
scoreboard players display name var_room_name gr_pinksb "§a§l当前房间: §rBakery"
...
title @a[team=pink] title "§e吃掉全部蛋糕！"
# Give items
clear @a[team=pink]
effect clear @a[team=pink] saturation
effect give @a[team=pink] hunger infinite 255 true
