...
execute as @e[type=minecraft:area_effect_cloud,tag=gr_orangeanchor] at @s run fill ~25 ~10 ~27 ~27 ~10 ~25 air
execute as @e[type=minecraft:area_effect_cloud,tag=gr_orangeanchor] at @s run fill ~28 ~10 ~18 ~28 ~10 ~20 air
execute as @e[type=minecraft:area_effect_cloud,tag=gr_orangeanchor] at @s run fill ~28 ~10 ~10 ~28 ~10 ~12 air
execute as @e[type=minecraft:area_effect_cloud,tag=gr_orangeanchor] at @s run fill ~25 ~10 ~2 ~27 ~10 ~4 air
...
# Announce position
tellraw @a[team=!orange] ["",{"translate":"team.orange"},"§7第",{"score":{"name": "1","objective": "gr_indvroom"},"color": "aqua"},"§7个完成了房间","§e[","§6City Targets","§e]"]
tellraw @a[team=orange] ["","§7你","§7第",{"score":{"name": "1","objective": "gr_indvroom"},"color": "aqua"},"§7个完成了房间","§e[","§6City Targets","§e]"]
# Initiate next room
