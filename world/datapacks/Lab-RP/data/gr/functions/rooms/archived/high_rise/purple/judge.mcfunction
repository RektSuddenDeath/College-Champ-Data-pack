...
execute as @e[type=area_effect_cloud,tag=gr_purpleanchor] at @s if block ~31 ~10 ~3 oak_button[powered=true] run kill @e[type=chest_minecart,tag=purple,tag=grroom]
execute as @e[type=area_effect_cloud,tag=gr_purpleanchor] at @s if block ~31 ~10 ~3 oak_button[powered=true] run summon chest_minecart ~30 ~11 ~1 {Tags:["purple","grroom"]}
execute as @e[type=area_effect_cloud,tag=gr_purpleanchor] at @s if block ~31 ~10 ~3 oak_button[powered=true] run setblock ~31 ~10 ~3 oak_button[facing=south]
#
