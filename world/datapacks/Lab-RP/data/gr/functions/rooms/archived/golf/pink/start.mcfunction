...
# Modify scoreboard
scoreboard players display name var_room_name gr_pinksb "§a§l当前房间: §rGolf"
...
title @a[team=pink] title "§e将你的队友射入洞中！"
# Give items
clear @a[team=pink]
give @a[team=pink] stick{Enchantments:[{id:"knockback",lvl:2}]}
