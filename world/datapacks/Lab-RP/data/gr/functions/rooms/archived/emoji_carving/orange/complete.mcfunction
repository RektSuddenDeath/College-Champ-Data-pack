...
execute as @e[type=minecraft:area_effect_cloud,tag=gr_orangeanchor] at @s run fill ~5 ~10 ~22 ~5 ~13 ~24 air
execute as @e[type=minecraft:area_effect_cloud,tag=gr_orangeanchor] at @s run fill ~5 ~10 ~6 ~5 ~13 ~8 air
# Playsound
...
# Announce position
tellraw @a[team=!orange] ["",{"translate":"team.orange"},"§7第",{"score":{"name": "4","objective": "gr_indvroom"},"color": "aqua"},"§7个完成了房间","§e[","§6Emoji Carving","§e]"]
tellraw @a[team=orange] ["","§7你","§7第",{"score":{"name": "4","objective": "gr_indvroom"},"color": "aqua"},"§7个完成了房间","§e[","§6Emoji Carving","§e]"]
# Initiate next room
