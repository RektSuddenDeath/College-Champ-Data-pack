...
# Modify scoreboard
scoreboard players display name var_room_name gr_bluesb "§a§l当前房间: §rBakery"
...
title @a[team=blue] title "§e吃掉全部蛋糕！"
# Give items
clear @a[team=blue]
effect clear @a[team=blue] saturation
effect give @a[team=blue] hunger infinite 255 true
