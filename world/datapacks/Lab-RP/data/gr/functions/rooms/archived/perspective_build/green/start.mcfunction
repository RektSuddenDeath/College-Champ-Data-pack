...
# Modify scoreboard
scoreboard players display name var_room_name gr_greensb "§a§l当前房间: §rPerspective Build"
...
# Give items
clear @a[team=green]
give @a[team=green] iron_pickaxe{Unbreakable:1b,CanDestroy:[redstone_block,lapis_block,emerald_block,raw_gold_block]}
# 开始计时
