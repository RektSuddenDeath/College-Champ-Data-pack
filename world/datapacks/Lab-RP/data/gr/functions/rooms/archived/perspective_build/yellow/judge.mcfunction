...
execute as @e[type=area_effect_cloud,tag=gr_yellowanchor] at @s run fill ~13 ~10 ~19 ~19 ~14 ~19 air
execute as @e[type=area_effect_cloud,tag=gr_yellowanchor] at @s run fill ~13 ~10 ~19 ~13 ~14 ~25 air
execute as @e[type=area_effect_cloud,tag=gr_yellowanchor] at @s run fill ~13 ~10 ~25 ~19 ~14 ~25 air
execute as @e[type=area_effect_cloud,tag=gr_yellowanchor] at @s run fill ~19 ~10 ~19 ~19 ~14 ~25 air
...
execute as @e[type=area_effect_cloud,tag=gr_yellowanchor] at @s if blocks ~14 ~9 ~6 ~18 ~13 ~10 ~14 ~9 ~20 all run scoreboard players add 1 gr_yellowobj 1
