...
# Modify scoreboard
scoreboard players display name var_room_name gr_greensb "§a§l当前房间: §rTwo Dimensions"
...
title @a[team=green] title "§e收集所需物品！"
# Give items
clear @a[team=green]
recipe give @a[team=green] comparator
recipe give @a[team=green] clock
# 开始计时
