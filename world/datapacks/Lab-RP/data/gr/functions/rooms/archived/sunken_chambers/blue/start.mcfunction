...
# Status Effects
scoreboard players set @a[team=blue] univ_death 0
effect clear @a[team=blue] resistance
effect give @a[team=blue] absorption infinite 1 true
execute as @a[team=blue] run attribute @s generic.max_health base set 1.0

# Add a team phase
scoreboard players add blue gr_teamphase 1

# Modify scoreboard
scoreboard players display name var_room_name gr_bluesb "§a§l当前房间: §rSunken Chambers"
