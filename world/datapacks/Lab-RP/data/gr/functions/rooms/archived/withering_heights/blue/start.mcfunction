...
# Modify scoreboard
scoreboard players display name var_room_name gr_bluesb "§a§l当前房间: §rWithering Heights"
...
give @a[team=blue] bow{Unbreakable:1b}
give @a[team=blue] arrow 16

execute as @e[type=minecraft:area_effect_cloud,tag=gr_blueanchor] at @s run summon wither ~17 94 ~14 {Tags:["gr_blue"],Health:150f}
