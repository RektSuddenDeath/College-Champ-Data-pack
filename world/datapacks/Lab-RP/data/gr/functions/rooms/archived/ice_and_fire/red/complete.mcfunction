...
execute as @e[type=minecraft:area_effect_cloud,tag=gr_redanchor] at @s run fill ~14 101 ~16 ~14 101 ~14 air
...
# Announce position
tellraw @a[team=!red] ["",{"translate":"team.red"},"§7第",{"score":{"name": "3","objective": "gr_indvroom"},"color": "aqua"},"§7个完成了房间","§e[","§bIce and Fire","§e]"]
tellraw @a[team=red] ["","§7你","§7第",{"score":{"name": "3","objective": "gr_indvroom"},"color": "aqua"},"§7个完成了房间","§e[","§bIce and Fire","§e]"]
# Initiate next room
