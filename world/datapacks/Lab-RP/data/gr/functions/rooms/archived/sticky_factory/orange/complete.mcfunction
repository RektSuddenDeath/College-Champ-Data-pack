...
execute as @e[type=minecraft:area_effect_cloud,tag=gr_orangeanchor] at @s run fill ~8 ~10 ~6 ~8 ~12 ~8 air
execute as @e[type=minecraft:area_effect_cloud,tag=gr_orangeanchor] at @s run fill ~8 ~10 ~22 ~8 ~12 ~24 air
# Playsound
...
# Announce position
tellraw @a[team=!orange] ["",{"translate":"team.orange"},"§7第",{"score":{"name": "4","objective": "gr_indvroom"},"color": "aqua"},"§7个完成了房间","§e[","§aSticky Factory","§e]"]
tellraw @a[team=orange] ["","§7你","§7第",{"score":{"name": "4","objective": "gr_indvroom"},"color": "aqua"},"§7个完成了房间","§e[","§aSticky Factory","§e]"]
# Initiate next room
