...
# Modify scoreboard
scoreboard players display name var_room_name gr_bluesb "§a§l当前房间: §rMesa Range"
...
title @a[team=blue] title "§e击碎所有陶罐！"
# Give items
clear @a[team=blue]
give @a[team=blue] bow{Unbreakable:1b} 3
give @a[team=blue] arrow 192
# 开始计时
