...
# Modify scoreboard
scoreboard players display name var_room_name gr_purplesb "§a§l当前房间: §rGolf"
...
title @a[team=purple] title "§e将你的队友射入洞中！"
# Give items
clear @a[team=purple]
give @a[team=purple] stick{Enchantments:[{id:"knockback",lvl:2}]}
