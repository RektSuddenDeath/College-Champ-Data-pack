...
execute as @e[type=minecraft:area_effect_cloud,tag=gr_greenanchor] at @s run fill ~5 ~1 ~14 ~5 ~3 ~16 air
# Playsound
...
# Announce position
tellraw @a[team=!green] ["",{"translate":"team.green"},"§7第",{"score":{"name": "4","objective": "gr_indvroom"},"color": "aqua"},"§7个完成了房间","§e[","§bGolf","§e]"]
tellraw @a[team=green] ["","§7你","§7第",{"score":{"name": "4","objective": "gr_indvroom"},"color": "aqua"},"§7个完成了房间","§e[","§bGolf","§e]"]
# Initiate next room
