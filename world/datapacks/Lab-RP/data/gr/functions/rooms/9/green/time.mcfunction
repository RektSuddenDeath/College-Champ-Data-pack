...
# 显示房间目标和当前用时
execute if score green gr_currentsec matches 0..9 run title @a[team=green] actionbar ["","[§e!§r]"," 前往终点吧！"]
execute if score green gr_currentsec matches 10..59 run title @a[team=green] actionbar ["","[§e!§r]"," 前往终点吧！"]