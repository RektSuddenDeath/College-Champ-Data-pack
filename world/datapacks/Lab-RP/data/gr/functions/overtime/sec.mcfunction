...
scoreboard players add reduceSec gr_game 1
scoreboard players add overtimesec gr_game 1
execute if score reduceSec gr_game matches 4.. run scoreboard players add reducedScore gr_game 4
execute if score reduceSec gr_game matches 4.. run scoreboard players set reduceSec gr_game 0
...
execute if score minute master.timer matches 0 if score second master.timer matches 0 run function gr:end
execute if score completed gr_game >= 3 math run function gr:end

execute if score gameflag gr_game matches 1 run schedule function gr:overtime/sec 1s