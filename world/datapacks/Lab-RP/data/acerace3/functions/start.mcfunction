...
schedule clear acerace3:beginlistener
...
spawnpoint @a -29993 116 -30026
scoreboard objectives add ar_cp dummy
scoreboard players set @a ar_cp 0

# Removes glass, plays sound
fill -30017 114 -30026 -29993 116 -30026 air
fill -29992 116 -30037 -30018 114 -30037 air
...
function acerace3:effectblock/unelytra
function acerace3:effectblock/speed5
function acerace3:effectblock/jump10
function acerace3:effectblock/jump20
#function utils:launchpad/loop

scoreboard objectives add ar_aqualauncher dummy
scoreboard players set @a ar_aqualauncher 0
#function acerace3:effectblock/aqualauncher
# Timing point
function master:timer/timeleft/10min
function acerace3:timing/master
function acerace3:scoreboard/refresh
#
##BOAT
