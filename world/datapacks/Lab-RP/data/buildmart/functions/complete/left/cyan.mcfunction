...
execute as @e[type=marker,tag=zone_left,tag=cyan] run scoreboard players operation @s bm_leftplotNo = cyan bm_normalcomps
execute as @e[type=marker,tag=zone_left,tag=cyan] run scoreboard players operation @s bm_leftplotNo += 2 math

execute as @e[type=marker,tag=zone_left,tag=cyan,tag=bm_example,limit=1,sort=nearest] at @s run function buildmart:copy/find_normal_left
