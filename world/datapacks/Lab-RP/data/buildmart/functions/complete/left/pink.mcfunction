...
execute as @e[type=marker,tag=zone_left,tag=pink] run scoreboard players operation @s bm_leftplotNo = pink bm_normalcomps
execute as @e[type=marker,tag=zone_left,tag=pink] run scoreboard players operation @s bm_leftplotNo += 2 math

execute as @e[type=marker,tag=zone_left,tag=pink,tag=bm_example,limit=1,sort=nearest] at @s run function buildmart:copy/find_normal_left
