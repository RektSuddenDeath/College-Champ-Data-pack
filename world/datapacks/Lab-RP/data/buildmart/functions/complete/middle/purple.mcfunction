...
execute as @e[type=marker,tag=zone_middle,tag=purple] run scoreboard players operation @s bm_midplotNo = purple bm_normalcomps
execute as @e[type=marker,tag=zone_middle,tag=purple] run scoreboard players operation @s bm_midplotNo += 2 math

execute as @e[type=marker,tag=zone_middle,tag=purple,tag=bm_example,limit=1,sort=nearest] at @s run function buildmart:copy/find_normal_middle
