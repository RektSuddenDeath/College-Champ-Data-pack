...
execute if score map sba_game matches 1 run summon area_effect_cloud 14000 0 14000 {Duration:999999,Tags:[skybattle,bordercenter]}
execute if score map sba_game matches 2 run summon area_effect_cloud 24000 0 24000 {Duration:999999,Tags:[skybattle,bordercenter]}
execute if score map sba_game matches 3 run summon area_effect_cloud 34000 0 34000 {Duration:999999,Tags:[skybattle,bordercenter]}
execute if score map sba_game matches 4 run summon area_effect_cloud 44000 0 44000 {Duration:999999,Tags:[skybattle,bordercenter]}
