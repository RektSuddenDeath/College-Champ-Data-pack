...
tellraw @a ["§b[§r褿§b] ",{"translate":"team.orange"},"§b已通过存档点","§f#1","§b!"]
...
function railroadrush:checkpoint/1/orange/summon_railfixer
function railroadrush:checkpoint/2/orange/setup