...
tellraw @a ["§b[§r褿§b] ",{"translate":"team.yellow"},"§b已通过存档点","§f#1","§b!"]
...
function railroadrush:checkpoint/1/yellow/summon_railfixer
function railroadrush:checkpoint/2/yellow/setup