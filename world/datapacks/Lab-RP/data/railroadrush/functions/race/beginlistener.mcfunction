...
execute if score pause master.timer matches 0 run scoreboard players remove second master.timer 1

execute if score second master.timer matches 0.. if score minute master.timer matches 19 run team modify timer prefix [{"text":"竞逐开始: ","color":"red"},{"text":"19","color":"white"}]
execute if score second master.timer matches 0.. if score minute master.timer matches 18 run team modify timer prefix [{"text":"竞逐开始: ","color":"red"},{"text":"18","color":"white"}]
execute if score second master.timer matches 0.. if score minute master.timer matches 17 run team modify timer prefix [{"text":"竞逐开始: ","color":"red"},{"text":"17","color":"white"}]
execute if score second master.timer matches 0.. if score minute master.timer matches 16 run team modify timer prefix [{"text":"竞逐开始: ","color":"red"},{"text":"16","color":"white"}]
execute if score second master.timer matches 0.. if score minute master.timer matches 15 run team modify timer prefix [{"text":"竞逐开始: ","color":"red"},{"text":"15","color":"white"}]
execute if score second master.timer matches 0.. if score minute master.timer matches 14 run team modify timer prefix [{"text":"竞逐开始: ","color":"red"},{"text":"14","color":"white"}]
execute if score second master.timer matches 0.. if score minute master.timer matches 13 run team modify timer prefix [{"text":"竞逐开始: ","color":"red"},{"text":"13","color":"white"}]
execute if score second master.timer matches 0.. if score minute master.timer matches 12 run team modify timer prefix [{"text":"竞逐开始: ","color":"red"},{"text":"12","color":"white"}]
execute if score second master.timer matches 0.. if score minute master.timer matches 11 run team modify timer prefix [{"text":"竞逐开始: ","color":"red"},{"text":"11","color":"white"}]
execute if score second master.timer matches 0.. if score minute master.timer matches 10 run team modify timer prefix [{"text":"竞逐开始: ","color":"red"},{"text":"10","color":"white"}]
execute if score second master.timer matches 0.. if score minute master.timer matches 9 run team modify timer prefix [{"text":"竞逐开始: ","color":"red"},{"text":"9","color":"white"}]
execute if score second master.timer matches 0.. if score minute master.timer matches 8 run team modify timer prefix [{"text":"竞逐开始: ","color":"red"},{"text":"8","color":"white"}]
execute if score second master.timer matches 0.. if score minute master.timer matches 7 run team modify timer prefix [{"text":"竞逐开始: ","color":"red"},{"text":"7","color":"white"}]
execute if score second master.timer matches 0.. if score minute master.timer matches 6 run team modify timer prefix [{"text":"竞逐开始: ","color":"red"},{"text":"6","color":"white"}]
execute if score second master.timer matches 0.. if score minute master.timer matches 5 run team modify timer prefix [{"text":"竞逐开始: ","color":"red"},{"text":"5","color":"white"}]
execute if score second master.timer matches 0.. if score minute master.timer matches 4 run team modify timer prefix [{"text":"竞逐开始: ","color":"red"},{"text":"4","color":"white"}]
execute if score second master.timer matches 0.. if score minute master.timer matches 3 run team modify timer prefix [{"text":"竞逐开始: ","color":"red"},{"text":"3","color":"white"}]
execute if score second master.timer matches 0.. if score minute master.timer matches 2 run team modify timer prefix [{"text":"竞逐开始: ","color":"red"},{"text":"2","color":"white"}]
execute if score second master.timer matches 0.. if score minute master.timer matches 1 run team modify timer prefix [{"text":"竞逐开始: ","color":"red"},{"text":"1","color":"white"}]
execute if score second master.timer matches 0.. if score minute master.timer matches 0 run team modify timer prefix [{"text":"竞逐开始: ","color":"red"},{"text":"0","color":"white"}]
...
execute if score second master.timer matches 3 if score pause master.timer matches 0 run function railroadrush:race/timeannounce/3
execute if score second master.timer matches 2 if score pause master.timer matches 0 run function railroadrush:race/timeannounce/2
execute if score second master.timer matches 1 if score pause master.timer matches 0 run function railroadrush:race/timeannounce/1
execute if score second master.timer matches 0 run function railroadrush:race/start
execute if score second master.timer matches 0 run return 1
schedule function railroadrush:race/beginlistener 1s