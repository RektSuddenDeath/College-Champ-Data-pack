...
#
execute if score second master.timer matches 0.. if score minute master.timer matches 10 run team modify timer prefix ["",{"text":"加时: ","color":"red","bold":true},{"text":"10","color":"white"}]
execute if score second master.timer matches 0.. if score minute master.timer matches 9 run team modify timer prefix ["",{"text":"加时: ","color":"red","bold":true},{"text":"9","color":"white"}]
execute if score second master.timer matches 0.. if score minute master.timer matches 8 run team modify timer prefix ["",{"text":"加时: ","color":"red","bold":true},{"text":"8","color":"white"}]
execute if score second master.timer matches 0.. if score minute master.timer matches 7 run team modify timer prefix ["",{"text":"加时: ","color":"red","bold":true},{"text":"7","color":"white"}]
execute if score second master.timer matches 0.. if score minute master.timer matches 6 run team modify timer prefix ["",{"text":"加时: ","color":"red","bold":true},{"text":"6","color":"white"}]
execute if score second master.timer matches 0.. if score minute master.timer matches 5 run team modify timer prefix ["",{"text":"加时: ","color":"red","bold":true},{"text":"5","color":"white"}]
execute if score second master.timer matches 0.. if score minute master.timer matches 4 run team modify timer prefix ["",{"text":"加时: ","color":"red","bold":true},{"text":"4","color":"white"}]
execute if score second master.timer matches 0.. if score minute master.timer matches 3 run team modify timer prefix ["",{"text":"加时: ","color":"red","bold":true},{"text":"3","color":"white"}]
execute if score second master.timer matches 0.. if score minute master.timer matches 2 run team modify timer prefix ["",{"text":"加时: ","color":"red","bold":true},{"text":"2","color":"white"}]
execute if score second master.timer matches 0.. if score minute master.timer matches 1 run team modify timer prefix ["",{"text":"加时: ","color":"red","bold":true},{"text":"1","color":"white"}]
execute if score second master.timer matches 0.. if score minute master.timer matches 0 run team modify timer prefix ["",{"text":"加时: ","color":"red","bold":true},{"text":"0","color":"white"}]
...
scoreboard players add extra_bartick pkw2_game 1
execute if score extra_bartick pkw2_game matches 3 run function pkw2:bossbar/ticktime
execute if score extra_bartick pkw2_game matches 3 run scoreboard players set extra_bartick pkw2_game 0
schedule clear pkw2:bossbar/ticktime

execute if score minute master.timer matches 0 if score second master.timer matches 1..30 run execute as @a at @s run playsound sound.timer_danger_normal record @s
execute if score minute master.timer matches 0 if score second master.timer matches 1..15 run execute as @a at @s run playsound sound.timer_danger_high record @s

# Loop
execute if score gameflag pkw2_game matches 1 run schedule function pkw2:timer/overtime/sec 1s