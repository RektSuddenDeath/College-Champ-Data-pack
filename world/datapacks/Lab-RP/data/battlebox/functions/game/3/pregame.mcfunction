...
tp @a[team=yellow] -21 33 75 270 0
tp @a[team=blue] 21 33 150 90 0
tp @a[team=green] -21 33 150 270 0
...
spawnpoint @a[team=yellow] -21 33 75
...
title @a title "回合 3/7"
title @a[team=red] subtitle ["",{"text": "红队","color": "red"}," vs. ",{"text": "黄队","color": "yellow"}]
title @a[team=blue] subtitle ["",{"text": "蓝队","color": "blue"}," vs. ",{"text": "绿队","color": "green"}]
title @a[team=green] subtitle ["",{"text": "绿队","color": "green"}," vs. ",{"text": "蓝队","color": "blue"}]
title @a[team=yellow] subtitle ["",{"text": "黄队","color": "yellow"}," vs. ",{"text": "红队","color": "red"}]
title @a[team=cyan] subtitle ["",{"text": "青队","color":"dark_aqua"}," vs. ",{"text": "紫队","color": "dark_purple"}]
title @a[team=pink] subtitle ["",{"text": "粉队","color":"light_purple"}," vs. ",{"text": "橙队","color":"gold"}]
title @a[team=orange] subtitle ["",{"text": "橙队","color":"gold"}," vs. ",{"text": "粉队","color":"light_purple"}]
title @a[team=purple] subtitle ["",{"text": "紫队","color": "dark_purple"}," vs. ",{"text": "青队","color":"dark_aqua"}]
#endregion
...
function battlebox:scoreboard/game3
execute if score remix bb_game matches 0 run schedule function battlebox:game/3/ready 15s
execute if score remix bb_game matches 1 run schedule function battlebox:game/3/ready 25s
scoreboard objectives setdisplay below_name health
scoreboard players set completed bb_game 0
scoreboard players set round bb_game 3

function battlebox:statusbar/pregameinit

# Transcript
tellraw @a[tag=_transcript] ["  §bTranscript >> Round roster:"]
tellraw @a[tag=_transcript] ["  §bTranscript >> ","§c红队","§7 vs."," §e黄队"]
tellraw @a[tag=_transcript] ["  §bTranscript >> ","§a绿队","§7 vs."," §9蓝队"]
tellraw @a[tag=_transcript] ["  §bTranscript >> ","§3青队","§7 vs."," §5紫队"]
tellraw @a[tag=_transcript] ["  §bTranscript >> ","§d粉队","§7 vs."," §6橙队"]