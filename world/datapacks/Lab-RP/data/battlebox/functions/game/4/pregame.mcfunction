...
tp @a[team=cyan] -21 33 75 270 0
tp @a[team=blue] 21 33 150 90 0
tp @a[team=pink] -21 33 150 270 0
...
spawnpoint @a[team=cyan] -21 33 75
spawnpoint @a[team=blue] 21 33 150
spawnpoint @a[team=pink] -21 33 150
...
function battlebox:scoreboard/game4
execute if score remix bb_game matches 0 run schedule function battlebox:game/4/ready 15s
execute if score remix bb_game matches 1 run schedule function battlebox:game/4/ready 25s
scoreboard objectives setdisplay below_name health
scoreboard players set completed bb_game 0
scoreboard players set round bb_game 4
