...
execute if score minute master.timer matches 0 if score second master.timer matches 0 run function battlebox:game/5/timeout
execute if score completed bb_game matches 4 run function battlebox:game/5/end
execute if score gameflag bb_game matches 1 run schedule function battlebox:game/5/detection 1t