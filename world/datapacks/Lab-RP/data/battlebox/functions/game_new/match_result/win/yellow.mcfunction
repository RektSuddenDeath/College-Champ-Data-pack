...
execute if score gameflag bb_game matches 1 as @e[type=marker,tag=bb_yellowanchor] at @s run fill ~1 ~ ~1 ~-1 ~ ~-1 yellow_concrete
...
# Make enemy lose
$function battlebox:game_new/match_result/lose/$(yellow)
...
# Transcript
tellraw @a[tag=_transcript] ["  §bTranscript >> ",{"translate":"team.yellow"},"§f占领了中心点！"," §7[",{"score":{"name": "hour","objective": "_transcript"},"color": "gray"},"§7:",{"score":{"name": "minute_padding","objective": "_transcript"},"color": "gray"},{"score":{"name": "minute","objective": "_transcript"},"color": "gray"},"§7:",{"score":{"name": "second_padding","objective": "_transcript"},"color": "gray"},{"score":{"name": "second","objective": "_transcript"},"color": "gray"},"§7]"]
