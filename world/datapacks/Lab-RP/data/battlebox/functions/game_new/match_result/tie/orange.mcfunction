...
title @a[team=orange] title ["§e平局！"]
title @a[team=orange] subtitle ["§eThat's a whoopsie."]

tellraw @a[team=orange] ["§6[§r曺§6] ","§6回合战平！下次要更快一点……"]
clear @a[team=orange]
...
scoreboard players operation @a[team=orange] bb_indvscore += tie bb_stats 
