...
title @a[team=pink] title ["§e平局！"]
title @a[team=pink] subtitle ["§eThat's a whoopsie."]

tellraw @a[team=pink] ["§6[§r曺§6] ","§6回合战平！下次要更快一点……"]
clear @a[team=pink]
...
scoreboard players operation @a[team=pink] bb_indvscore += tie bb_stats 
